...
public class WilliamsR extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.WilliamsR series(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator series type.
     */
    public com.chart.all.anychart.core.stock.indicators.WilliamsR series(String type) {
