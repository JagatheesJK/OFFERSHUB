...
public class LegendItem extends Text {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem disablePointerEvents(Boolean enabled) {
     ...
     * Draws legend item.
     */
    public com.chart.all.anychart.core.ui.LegendItem draw() {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem enabled(Boolean enabled) {
...
{@link https://www.w3schools.com/html/html_colors.asp}
     */
    public com.chart.all.anychart.core.ui.LegendItem fontColor(String color) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem fontDecoration(com.chart.all.anychart.graphics.vector.text.Decoration value) {
     ...
     * Setter for the text font decoration.
     */
    public com.chart.all.anychart.core.ui.LegendItem fontDecoration(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem fontFamily(String family) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem fontOpacity(Number opacity) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem fontSize(String size) {
     ...
     * Setter for the text font size.
     */
    public com.chart.all.anychart.core.ui.LegendItem fontSize(Number size) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem fontStyle(com.chart.all.anychart.graphics.vector.text.FontStyle style) {
     ...
     * Setter for the text font style.
     */
    public com.chart.all.anychart.core.ui.LegendItem fontStyle(String style) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem fontVariant(com.chart.all.anychart.graphics.vector.text.FontVariant value) {
     ...
     * Setter for the text font variant.
     */
    public com.chart.all.anychart.core.ui.LegendItem fontVariant(String value) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.core.ui.LegendItem fontWeight(String weight) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.core.ui.LegendItem fontWeight(Number weight) {
     ...
     */
    public com.chart.all.anychart.math.Rect getContentBounds() {
        return new com.chart.all.anychart.math.Rect(jsBase + ".getContentBounds()");
    }
    /**
     ...
     */
    public com.chart.all.anychart.graphics.vector.Text getTextElement() {
        return new com.chart.all.anychart.graphics.vector.Text(jsBase + ".getTextElement()");
    }
    /**
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem hAlign(com.chart.all.anychart.graphics.vector.text.HAlign align) {
     ...
     * Setter for the text horizontal align.
     */
    public com.chart.all.anychart.core.ui.LegendItem hAlign(String align) {
     ...
     */
    public void iconFill(com.chart.all.anychart.graphics.vector.Fill value) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem iconHatchFill(com.chart.all.anychart.graphics.vector.PatternFill patternFillOrType, String color, Number thickness, Number size) {
     ...
     * Setter for icon hatch fill settings.
     */
    public com.chart.all.anychart.core.ui.LegendItem iconHatchFill(com.chart.all.anychart.graphics.vector.HatchFill patternFillOrType, String color, Number thickness, Number size) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %s, %s);", (patternFillOrType != null) ? patternFillOrType.getJsBase() : null, wrapQuotes(color), thickness, size));
     ...
     * Setter for icon hatch fill settings.
     */
    public com.chart.all.anychart.core.ui.LegendItem iconHatchFill(String patternFillOrType, String color, Number thickness, Number size) {
     ...
     * Setter for icon hatch fill settings.
     */
    public com.chart.all.anychart.core.ui.LegendItem iconHatchFill(com.chart.all.anychart.graphics.vector.hatchfill.HatchFillType patternFillOrType, String color, Number thickness, Number size) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %s, %s);", (patternFillOrType != null) ? patternFillOrType.getJsBase() : null, wrapQuotes(color), thickness, size));
     ...
     */
    public void iconStroke(com.chart.all.anychart.graphics.vector.Stroke value) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem iconTextSpacing(Number value) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.core.ui.LegendItem letterSpacing(String spacing) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.core.ui.LegendItem letterSpacing(Number spacing) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.core.ui.LegendItem lineHeight(String height) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.core.ui.LegendItem lineHeight(Number height) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem maxHeight(Number value) {
     ...
     * Setter for the maximal height of a legend item.
     */
    public com.chart.all.anychart.core.ui.LegendItem maxHeight(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem maxWidth(Number value) {
     ...
     * Setter for the maximal width of a legend item.
     */
    public com.chart.all.anychart.core.ui.LegendItem maxWidth(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem selectable(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem textDirection(com.chart.all.anychart.graphics.vector.text.Direction direction) {
     ...
     * Setter for the text direction.
     */
    public com.chart.all.anychart.core.ui.LegendItem textDirection(String direction) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem textIndent(Number indent) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem textOverflow(com.chart.all.anychart.graphics.vector.text.TextOverflow value) {
     ...
     * Setter for the text overflow settings.
     */
    public com.chart.all.anychart.core.ui.LegendItem textOverflow(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem textSettings(String name, String settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.core.ui.LegendItem textSettings(String name, Number settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.core.ui.LegendItem textSettings(String name, Boolean settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".textSettings(%s, %s);", wrapQuotes(name), settings));
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem useHtml(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem vAlign(com.chart.all.anychart.graphics.vector.text.VAlign align) {
     ...
     * Setter for the text vertical align.
     */
    public com.chart.all.anychart.core.ui.LegendItem vAlign(String align) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem wordBreak(com.chart.all.anychart.enums.WordBreak mode) {
     ...
     * Setter for the word-break mode.
     */
    public com.chart.all.anychart.core.ui.LegendItem wordBreak(String mode) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem wordWrap(com.chart.all.anychart.enums.WordWrap mode) {
     ...
     * Setter for the word-wrap mode.
     */
    public com.chart.all.anychart.core.ui.LegendItem wordWrap(String mode) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.ui.LegendItem container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.ui.LegendItem container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.ui.LegendItem container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.LegendItem parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.LegendItem parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.LegendItem parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.LegendItem parentBounds(Number left, Number top, Number width, Number height) {
