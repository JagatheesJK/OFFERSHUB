...
public class QuarterSettings extends Base {
     ...
     */
    public com.chart.all.anychart.core.utils.Quarter leftBottom() {
        return new com.chart.all.anychart.core.utils.Quarter(jsBase + ".leftBottom()");
    }
    /**
     * Setter for left-bottom quarter.
     */
    public com.chart.all.anychart.core.utils.QuarterSettings leftBottom(String settings) {
     ...
     */
    public com.chart.all.anychart.core.utils.Quarter leftTop() {
        return new com.chart.all.anychart.core.utils.Quarter(jsBase + ".leftTop()");
    }
    /**
     * Setter for left-top quarter.
     */
    public com.chart.all.anychart.core.utils.QuarterSettings leftTop(String settings) {
     ...
     */
    public com.chart.all.anychart.core.utils.Quarter rightBottom() {
        return new com.chart.all.anychart.core.utils.Quarter(jsBase + ".rightBottom()");
    }
    /**
     * Setter for right-bottom quarter.
     */
    public com.chart.all.anychart.core.utils.QuarterSettings rightBottom(String settings) {
     ...
     */
    public com.chart.all.anychart.core.utils.Quarter rightTop() {
        return new com.chart.all.anychart.core.utils.Quarter(jsBase + ".rightTop()");
    }
    /**
     * Setter for right-top quarter.
     */
    public com.chart.all.anychart.core.utils.QuarterSettings rightTop(String settings) {
