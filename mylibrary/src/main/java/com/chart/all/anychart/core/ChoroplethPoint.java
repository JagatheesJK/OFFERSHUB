...
import com.chart.all.anychart.core.SeriesPoint;
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     */
    public com.chart.all.anychart.core.ChoroplethPoint crs(String crs) {
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     */
    public com.chart.all.anychart.math.Rect getFeatureBounds() {
        return new com.chart.all.anychart.math.Rect(jsBase + ".getFeatureBounds()");
    }
    /**
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     ...
     */
    public com.chart.all.anychart.core.SeriesBase getSeries() {
        return new com.chart.all.anychart.core.SeriesBase(jsBase + ".getSeries()");
    }
    /**
...
<b>Note</b>: Works only after chart.draw() is called.
     ...
     */
    public com.chart.all.anychart.core.ChoroplethPoint hovered(Boolean enabled) {
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     */
    public com.chart.all.anychart.core.ChoroplethPoint middleX(Number xCoord) {
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     */
    public com.chart.all.anychart.core.ChoroplethPoint middleY(Number yCoord) {
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     */
    public com.chart.all.anychart.core.ChoroplethPoint scaleFactor(Number scaleFactor) {
     ...
     */
    public com.chart.all.anychart.core.ChoroplethPoint selected(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ChoroplethPoint set(String field, String value) {
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     */
    public com.chart.all.anychart.core.ChoroplethPoint translate(Number dx, Number dy) {
...
<b>Note:</b> Works only after {@link anychart.charts.Map#draw} is called.
     */
    public com.chart.all.anychart.core.ChoroplethPoint translation(Number dx, Number dy) {
