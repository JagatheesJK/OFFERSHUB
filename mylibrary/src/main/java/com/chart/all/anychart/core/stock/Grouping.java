...
public class Grouping extends Base {
     ...
     */
    public com.chart.all.anychart.core.stock.Grouping enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.stock.Grouping forced(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.stock.Grouping levels(com.chart.all.anychart.core.stock.grouping.Level levelsList) {
     ...
     * Setter for the data grouping levels.
     */
    public com.chart.all.anychart.core.stock.Grouping levels(String[] levelsList) {
     ...
     */
    public com.chart.all.anychart.core.stock.Grouping maxVisiblePoints(Number count) {
     ...
     */
    public com.chart.all.anychart.core.stock.Grouping minPixPerPoint(Number count) {
