...
public class OrdinalColor extends Base {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalColor colors(String[] colors) {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalColor inverted(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalColor names(String[] names) {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalColor ranges(String[] ranges) {
...
call of this method if needed.
     */
    public com.chart.all.anychart.scales.OrdinalColor startAutoCalc() {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalColor ticks(String ticks) {
