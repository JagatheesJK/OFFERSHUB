...
public class Base extends VisualBaseWithBounds {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base allowPointSettings(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bottom(String bottom) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(com.chart.all.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(com.chart.all.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(com.chart.all.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(Number x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(Number x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(Number x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(Number x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(Number x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(Number x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(Number x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(Number x, String y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(String x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(String x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(String x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(String x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(String x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(String x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(String x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.stock.series.Base bounds(String x, String y, String width, String height) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base colorScale(com.chart.all.anychart.scales.LinearColor settings) {
     ...
     * Setter for the color scale.
     */
    public com.chart.all.anychart.core.stock.series.Base colorScale(com.chart.all.anychart.scales.OrdinalColor settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     * Setter for the color scale.
     */
    public com.chart.all.anychart.core.stock.series.Base colorScale(String settings) {
     ...
     * Setter for the color scale.
     */
    public com.chart.all.anychart.core.stock.series.Base colorScale(com.chart.all.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.chart.all.anychart.core.stock.series.Base height(String height) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base hovered(String settings) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base labels(String settings) {
     ...
     * Setter for series labels.<br>
     */
    public com.chart.all.anychart.core.stock.series.Base labels(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.chart.all.anychart.core.stock.series.Base left(String left) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base legendItem(String settings) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base markers(String settings) {
     ...
     * Setter for the data markers.
     */
    public com.chart.all.anychart.core.stock.series.Base markers(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.chart.all.anychart.core.stock.series.Base maxHeight(String height) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base maxPointWidth(Number width) {
     ...
     * Setter for the maximum point width.
     */
    public com.chart.all.anychart.core.stock.series.Base maxPointWidth(String width) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.chart.all.anychart.core.stock.series.Base maxWidth(String width) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.chart.all.anychart.core.stock.series.Base minHeight(String height) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base minLabels(String settings) {
     ...
     * Setter for minimum labels.
     */
    public com.chart.all.anychart.core.stock.series.Base minLabels(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base minPointLength(Number length) {
     ...
     * Setter for the minimum point length.
     */
    public com.chart.all.anychart.core.stock.series.Base minPointLength(String length) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.chart.all.anychart.core.stock.series.Base minWidth(String width) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base name(String name) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base normal(String settings) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base pointWidth(Number width) {
     ...
     * Setter for the point width settings.
     */
    public com.chart.all.anychart.core.stock.series.Base pointWidth(String width) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base rendering(String settings) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.chart.all.anychart.core.stock.series.Base right(String right) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base seriesType(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base tooltip(String settings) {
     ...
     * Setter for the tooltip.
     */
    public com.chart.all.anychart.core.stock.series.Base tooltip(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.chart.all.anychart.core.stock.series.Base top(String top) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.chart.all.anychart.core.stock.series.Base width(String width) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base yScale(com.chart.all.anychart.scales.ScatterBase settings) {
     ...
     * Setter for the Y-scale.
     */
    public com.chart.all.anychart.core.stock.series.Base yScale(String settings) {
     ...
     * Setter for the Y-scale.
     */
    public com.chart.all.anychart.core.stock.series.Base yScale(com.chart.all.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".yScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.stock.series.Base container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.stock.series.Base container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.stock.series.Base parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.stock.series.Base parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.stock.series.Base parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.stock.series.Base parentBounds(Number left, Number top, Number width, Number height) {
