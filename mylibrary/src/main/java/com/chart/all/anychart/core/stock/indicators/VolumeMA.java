...
public class VolumeMA extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.VolumeMA maPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.Base maSeries(com.chart.all.anychart.enums.StockSeriesType type) {
        return new com.chart.all.anychart.core.stock.indicators.Base(String.format(Locale.US, jsBase + ".maSeries(%s)", (type != null) ? type.getJsBase() : null));
    }
    /**
     * Setter for the indicator moving average series type.
     */
    public com.chart.all.anychart.core.stock.indicators.Base maSeries(String type) {
        return new com.chart.all.anychart.core.stock.indicators.Base(String.format(Locale.US, jsBase + ".maSeries(%s)", wrapQuotes(type)));
    }
    /**
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.VolumeMA maType(com.chart.all.anychart.enums.MovingAverageType type) {
     ...
     * Setter for the smoothing type.
     */
    public com.chart.all.anychart.core.stock.indicators.VolumeMA maType(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base volumeSeries() {
        return new com.chart.all.anychart.core.stock.series.Base(jsBase + ".volumeSeries()");
    }
    /**
     * Setter for the indicator volume series type.
     */
    public com.chart.all.anychart.core.stock.indicators.VolumeMA volumeSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator volume series type.
     */
    public com.chart.all.anychart.core.stock.indicators.VolumeMA volumeSeries(String type) {
