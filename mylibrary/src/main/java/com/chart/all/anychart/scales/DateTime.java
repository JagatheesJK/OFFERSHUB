...
public class DateTime extends ScatterBase {
     ...
     */
    public com.chart.all.anychart.scales.DateTime alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public com.chart.all.anychart.scales.DateTime alignMinimum(Boolean enabled) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public com.chart.all.anychart.scales.DateTime extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public com.chart.all.anychart.scales.DateTime inverted(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.DateTime maximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.DateTime minimum(Number minimum) {
     ...
     */
    public com.chart.all.anychart.scales.DateTimeTicks minorTicks() {
        return new com.chart.all.anychart.scales.DateTimeTicks(jsBase + ".minorTicks()");
    }
    /**
     * Setter for the set of scale ticks in terms of data values.
     */
    public com.chart.all.anychart.scales.DateTime minorTicks(String settings) {
...
call of this method if needed.
     */
    public com.chart.all.anychart.scales.DateTime startAutoCalc() {
     ...
     */
    public com.chart.all.anychart.scales.DateTimeTicks ticks() {
        return new com.chart.all.anychart.scales.DateTimeTicks(jsBase + ".ticks()");
    }
    /**
     * Setter for the set of scale ticks in terms of data values.
     */
    public com.chart.all.anychart.scales.DateTime ticks(String settings) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public com.chart.all.anychart.scales.DateTime maxTicksCount(Number count) {
