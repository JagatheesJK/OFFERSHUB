...
<b>Note</b>: Works only after chart.draw() is called.
     ...
     */
    public com.chart.all.anychart.core.SeriesPoint hovered(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.SeriesPoint selected(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.SeriesPoint set(String field, String value) {
