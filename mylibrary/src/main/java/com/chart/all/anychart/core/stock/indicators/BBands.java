...
public class BBands extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.BBands deviation(Number deviation) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base lowerSeries() {
        return new com.chart.all.anychart.core.stock.series.Base(jsBase + ".lowerSeries()");
    }
    /**
     * Setter for the indicator Lower Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.BBands lowerSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator Lower Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.BBands lowerSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.BBands middleSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator Middle Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.BBands middleSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.BBands period(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.BBands rangeSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator Range Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.BBands rangeSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base upperSeries() {
        return new com.chart.all.anychart.core.stock.series.Base(jsBase + ".upperSeries()");
    }
    /**
     * Setter for the indicator Upper Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.BBands upperSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator Upper Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.BBands upperSeries(String type) {
