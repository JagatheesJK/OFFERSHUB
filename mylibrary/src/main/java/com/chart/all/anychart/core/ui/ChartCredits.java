...
public class ChartCredits extends Base {
     ...
     */
    public com.chart.all.anychart.core.ui.ChartCredits alt(String text) {
     ...
     */
    public com.chart.all.anychart.core.ui.ChartCredits enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.ChartCredits imgAlt(String text) {
...
<b>Note:</b> You can't customize credits without <u>a license key</u>. See <a href="https://www.anychart.com/buy/">AnyChart Licensing</a> to learn more.
     */
    public com.chart.all.anychart.core.ui.ChartCredits logoSrc(String logoSrc) {
     ...
     */
    public com.chart.all.anychart.core.ui.ChartCredits text(String text) {
     ...
     */
    public com.chart.all.anychart.core.ui.ChartCredits url(String url) {
