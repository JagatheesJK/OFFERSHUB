...
public class RenderingSettings extends Base {
     ...
     */
    public com.chart.all.anychart.core.series.RenderingSettings finish(String finishFunction) {
     ...
     */
    public com.chart.all.anychart.core.series.RenderingSettings needsWidth(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.series.RenderingSettings needsZero(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.series.RenderingSettings point(String pointFunction) {
     ...
     */
    public com.chart.all.anychart.core.series.RenderingSettings start(String startFunction) {
...
Change the point shape when the state changes.
     */
    public com.chart.all.anychart.core.series.RenderingSettings updatePoint(String pointFunction) {
     ...
     */
    public com.chart.all.anychart.core.series.RenderingSettings yValues(String[] value) {
