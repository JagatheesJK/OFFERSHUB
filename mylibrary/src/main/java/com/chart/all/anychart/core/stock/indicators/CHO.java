...
public class CHO extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.CHO fastPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.CHO maType(com.chart.all.anychart.enums.MovingAverageType type) {
     ...
     * Setter for the indicator smoothing type.
     */
    public com.chart.all.anychart.core.stock.indicators.CHO maType(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.CHO series(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator series type.
     */
    public com.chart.all.anychart.core.stock.indicators.CHO series(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.CHO slowPeriod(Number period) {
