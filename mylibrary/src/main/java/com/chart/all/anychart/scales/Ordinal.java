...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public com.chart.all.anychart.scales.Ordinal extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public com.chart.all.anychart.scales.Ordinal inverted(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.Ordinal names(String[] names) {
...
call of this method if needed.
     */
    public com.chart.all.anychart.scales.Ordinal startAutoCalc() {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalTicks ticks() {
        return new com.chart.all.anychart.scales.OrdinalTicks(jsBase + ".ticks()");
    }
    /**
     * Setter for set of scale ticks in terms of data values.
     */
    public com.chart.all.anychart.scales.Ordinal ticks(String ticks) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     * 
     */
    public com.chart.all.anychart.scales.Ordinal values(String[] values) {
     ...
     */
    public com.chart.all.anychart.scales.Ordinal weights(Number[] weights) {
