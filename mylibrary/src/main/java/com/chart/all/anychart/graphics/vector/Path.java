...
public class Path extends Shape {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
...
of the Y-axis, that is clockwise.
     */
    public com.chart.all.anychart.graphics.vector.Path arcTo(Number rx, Number ry, Number fromAngle, Number extent) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path arcToAsCurves(Number rx, Number ry, Number fromAngle, Number extent) {
...
Read more at {@link https://www.w3.org/TR/SVG/implnote.html#ArcImplementationNotes}
     */
    public com.chart.all.anychart.graphics.vector.Path arcToByEndPoint(Number x, Number y, Number rx, Number ry, Boolean largeArc, Boolean clockwiseArc) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path attr(String key, String value) {
...
with clockwise and counterclock drawing option.
     */
    public com.chart.all.anychart.graphics.vector.Path circularArc(Number cx, Number cy, Number rx, Number ry, Number fromAngle, Number sweep, Boolean lineTo) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path clear() {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path clip(com.chart.all.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.chart.all.anychart.graphics.vector.Path clip(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path close() {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path cursor(com.chart.all.anychart.graphics.vector.Cursor value) {
...
Each curve is defined by 3 points (6 coordinates) - two control points and an endpoint.
     */
    public com.chart.all.anychart.graphics.vector.Path curveTo(Number control1X, Number control1Y, Number control2X, Number control2Y, Number endX, Number endY, Number var_args) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path desc(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.chart.all.anychart.graphics.vector.Path disableStrokeScaling(Boolean value) {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.chart.all.anychart.graphics.vector.Path drag(com.chart.all.anychart.graphics.math.Rect value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path fill(com.chart.all.anychart.graphics.vector.Fill color) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path fill(String color, Number opacity) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path fill(com.chart.all.anychart.graphics.vector.GradientKey keys, Number angle, Boolean mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.chart.all.anychart.graphics.vector.Path fill(com.chart.all.anychart.graphics.vector.GradientKey keys, Number angle, com.chart.all.anychart.graphics.vector.Rect mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.chart.all.anychart.graphics.vector.Path fill(com.chart.all.anychart.graphics.vector.GradientKey keys, Number angle, String mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.chart.all.anychart.graphics.vector.Path fill(String[] keys, Number angle, Boolean mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.chart.all.anychart.graphics.vector.Path fill(String[] keys, Number angle, com.chart.all.anychart.graphics.vector.Rect mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.chart.all.anychart.graphics.vector.Path fill(String[] keys, Number angle, String mode, Number opacity) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path fill(com.chart.all.anychart.graphics.vector.GradientKey keys, Number cx, Number cy, com.chart.all.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
     ...
     * Radial gradient fill.
     */
    public com.chart.all.anychart.graphics.vector.Path fill(String[] keys, Number cx, Number cy, com.chart.all.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.chart.all.anychart.graphics.math.Coordinate getCurrentPoint() {
        return new com.chart.all.anychart.graphics.math.Coordinate(jsBase + ".getCurrentPoint()");
    }
    /**
     * Returns the height.
     */
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path id(String id) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path lineTo(Number x, Number y, Number var_args) {
...
Remember that if you call the <b>moveTo</b> method a few times in a row, only the last call will be applied.
     */
    public com.chart.all.anychart.graphics.vector.Path moveTo(Number x, Number y) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path parent(com.chart.all.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.chart.all.anychart.graphics.vector.Path parent(com.chart.all.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
...
Each curve is defined by 2 points (4 coordinates) - a control point and an endpoint.
     */
    public com.chart.all.anychart.graphics.vector.Path quadraticCurveTo(Number controlX, Number controlY, Number endX, Number endY, Number var_args) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path remove() {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path rotateByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Path rotateByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path scaleByAnchor(Number sx, Number sy, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.chart.all.anychart.graphics.vector.Path scaleByAnchor(Number sx, Number sy, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path setPosition(Number x, Number y) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Path setRotationByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Path setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.Stroke value) {
     ...
     * Sets a stroke using one parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.ColoredFill value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s);", (value != null) ? value.getJsBase() : null));
     ...
     * Sets a stroke using one parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.Stroke value, Number thickness, String dashpattern, String lineJoin, String lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.Stroke value, Number thickness, String dashpattern, String lineJoin, com.chart.all.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.Stroke value, Number thickness, String dashpattern, com.chart.all.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.Stroke value, Number thickness, String dashpattern, com.chart.all.anychart.graphics.vector.StrokeLineJoin lineJoin, com.chart.all.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.ColoredFill value, Number thickness, String dashpattern, String lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != null) ? value.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), wrapQuotes(lineCap)));
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.ColoredFill value, Number thickness, String dashpattern, String lineJoin, com.chart.all.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != null) ? value.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), (lineCap != null) ? lineCap.getJsBase() : null));
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.ColoredFill value, Number thickness, String dashpattern, com.chart.all.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != null) ? value.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, wrapQuotes(lineCap)));
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(com.chart.all.anychart.graphics.vector.ColoredFill value, Number thickness, String dashpattern, com.chart.all.anychart.graphics.vector.StrokeLineJoin lineJoin, com.chart.all.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != null) ? value.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, (lineCap != null) ? lineCap.getJsBase() : null));
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(String value, Number thickness, String dashpattern, String lineJoin, String lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(String value, Number thickness, String dashpattern, String lineJoin, com.chart.all.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(String value, Number thickness, String dashpattern, com.chart.all.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.chart.all.anychart.graphics.vector.Path stroke(String value, Number thickness, String dashpattern, com.chart.all.anychart.graphics.vector.StrokeLineJoin lineJoin, com.chart.all.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path strokeThickness(Number thickness) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path title(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path translate(Number tx, Number ty) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path visible(Boolean isVisible) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Path zIndex(Number value) {
     ...
     * 
     */
    public com.chart.all.anychart.graphics.vector.Path fill(String value) {
