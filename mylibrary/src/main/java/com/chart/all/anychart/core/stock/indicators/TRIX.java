...
public class TRIX extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX maType(com.chart.all.anychart.enums.MovingAverageType type) {
     ...
     * Setter for the smoothing type.
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX maType(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX period(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX signalMaType(String type) {
     ...
     * Setter for the signal smoothing type.
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX signalMaType(com.chart.all.anychart.enums.MovingAverageType type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX signalPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX signalSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator signal series type.
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX signalSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base trixSeries() {
        return new com.chart.all.anychart.core.stock.series.Base(jsBase + ".trixSeries()");
    }
    /**
     * Setter for the indicator TRIX series type.
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX trixSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator TRIX series type.
     */
    public com.chart.all.anychart.core.stock.indicators.TRIX trixSeries(String type) {
