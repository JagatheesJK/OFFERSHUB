...
public class NoDataSettings extends Base {
     ...
     */
    public com.chart.all.anychart.core.ui.Label label() {
        return new com.chart.all.anychart.core.ui.Label(jsBase + ".label()");
    }
    /**
     * Setter for no data label.
     */
    public com.chart.all.anychart.core.NoDataSettings label(String settings) {
     ...
     * Setter for no data label.
     */
    public com.chart.all.anychart.core.NoDataSettings label(Boolean settings) {
