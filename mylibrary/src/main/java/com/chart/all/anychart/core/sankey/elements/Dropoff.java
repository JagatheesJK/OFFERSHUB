...
public class Dropoff extends Base {
     ...
     */
    public com.chart.all.anychart.core.sankey.elements.Dropoff hovered(String settings) {
     ...
     */
    public com.chart.all.anychart.core.sankey.elements.Dropoff normal(String settings) {
     ...
     */
    public com.chart.all.anychart.core.sankey.elements.Dropoff tooltip(String settings) {
     ...
     * Setter for the dropoff element tooltip.
     */
    public com.chart.all.anychart.core.sankey.elements.Dropoff tooltip(Boolean settings) {
