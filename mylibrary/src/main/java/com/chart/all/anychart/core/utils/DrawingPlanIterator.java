...
import com.chart.all.anychart.data.Iterator;
...
public class DrawingPlanIterator extends Iterator {
     ...
     */
    public com.chart.all.anychart.core.utils.DrawingPlanIterator meta(String name, String value) {
     ...
     */
    public com.chart.all.anychart.core.utils.DrawingPlanIterator reset() {
