...
public class Padding extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.ui.table.Padding bottom(Number bottom) {
     ...
     * Setter for bottom padding.
     */
    public com.chart.all.anychart.core.ui.table.Padding bottom(String bottom) {
     ...
     */
    public com.chart.all.anychart.core.ui.table.Padding left(Number left) {
     ...
     * Setter for left padding.
     */
    public com.chart.all.anychart.core.ui.table.Padding left(String left) {
     ...
     */
    public com.chart.all.anychart.core.ui.table.Padding right(Number right) {
     ...
     * Setter for right padding.
     */
    public com.chart.all.anychart.core.ui.table.Padding right(String right) {
     ...
     */
    public com.chart.all.anychart.core.ui.table.Padding top(Number top) {
     ...
     * Setter for top padding.
     */
    public com.chart.all.anychart.core.ui.table.Padding top(String top) {
