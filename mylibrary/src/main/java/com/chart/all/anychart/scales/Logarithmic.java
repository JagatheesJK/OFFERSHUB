...
import com.chart.all.anychart.scales.Linear;
...
public class Logarithmic extends Linear {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public com.chart.all.anychart.scales.Logarithmic alignMinimum(Boolean enabled) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public com.chart.all.anychart.scales.Logarithmic extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public com.chart.all.anychart.scales.Logarithmic inverted(Boolean enabled) {
...
<b>Note:</b> Affects tick values auto calculation.
     */
    public com.chart.all.anychart.scales.Logarithmic logBase(Number baseValue) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic maximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic maximumGap(Number gap) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic minimum(Number minimum) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic minimumGap(Number gap) {
     ...
     */
    public com.chart.all.anychart.scales.ScatterTicks minorTicks() {
        return new com.chart.all.anychart.scales.ScatterTicks(jsBase + ".minorTicks()");
    }
    /**
     * Setter for set of scale minor ticks in terms of data values.
     */
    public com.chart.all.anychart.scales.Logarithmic minorTicks(String settings) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic softMaximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic softMinimum(Number minimum) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic stackDirection(com.chart.all.anychart.enums.ScaleStackDirection direction) {
     ...
     * Setter for the stacking direction.
     */
    public com.chart.all.anychart.scales.Logarithmic stackDirection(String direction) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic stackMode(com.chart.all.anychart.enums.ScaleStackMode value) {
     ...
     * Setter for the stacked mode.
     */
    public com.chart.all.anychart.scales.Logarithmic stackMode(String value) {
...
call of this method if needed.
     */
    public com.chart.all.anychart.scales.Logarithmic startAutoCalc() {
...
Flag to stick to zero value on auto calc if gaps lead to zero crossing.
     */
    public com.chart.all.anychart.scales.Logarithmic stickToZero(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.ScatterTicks ticks() {
        return new com.chart.all.anychart.scales.ScatterTicks(jsBase + ".ticks()");
    }
    /**
     * Setter for set of scale ticks in terms of data values.
     */
    public com.chart.all.anychart.scales.Logarithmic ticks(String settings) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic compareWith(com.chart.all.anychart.enums.ScaleCompareWithMode mode) {
     ...
     * Setter for the date which should be used as a changes zero for series.
     */
    public com.chart.all.anychart.scales.Logarithmic compareWith(String mode) {
     ...
     * Setter for the date which should be used as a changes zero for series.
     */
    public com.chart.all.anychart.scales.Logarithmic compareWith(Number mode) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic comparisonMode(com.chart.all.anychart.enums.ScaleComparisonMode mode) {
     ...
     * Setter for the scale changes mode.
     */
    public com.chart.all.anychart.scales.Logarithmic comparisonMode(String mode) {
     ...
     */
    public com.chart.all.anychart.scales.Logarithmic maxTicksCount(Number count) {
