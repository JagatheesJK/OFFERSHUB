...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public com.chart.all.anychart.editor.Editor dialogVisible(Boolean enabled) {
...
(example for the versioned file: https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public void getJavascript(com.chart.all.anychart.editor.JavascriptOptions outputOptions) {
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public com.chart.all.anychart.editor.Editor localization(String settings) {
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public com.chart.all.anychart.editor.Step step(com.chart.all.anychart.enums.EditorSteps stepName) {
        return new com.chart.all.anychart.editor.Step(String.format(Locale.US, jsBase + ".step(%s)", (stepName != null) ? stepName.getJsBase() : null));
    }
    /**
     * Getter for the step by its name.<br/>
<br>
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public com.chart.all.anychart.editor.Step step(String stepName) {
        return new com.chart.all.anychart.editor.Step(String.format(Locale.US, jsBase + ".step(%s)", wrapQuotes(stepName)));
    }
    /**
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public com.chart.all.anychart.editor.Step step(com.chart.all.anychart.enums.EditorSteps stepName, Boolean value) {
        return new com.chart.all.anychart.editor.Step(String.format(Locale.US, jsBase + ".step(%s, %s)", (stepName != null) ? stepName.getJsBase() : null, value));
    }
    /**
     * Setter for the step settings.<br/>
Call this method only before {api:anychart.editor.Editor#render}render{api} chart editor.<br/>
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public com.chart.all.anychart.editor.Step step(String stepName, Boolean value) {
        return new com.chart.all.anychart.editor.Step(String.format(Locale.US, jsBase + ".step(%s, %s)", wrapQuotes(stepName), value));
    }
