...
public class Geo extends Base {
     ...
     */
    public com.chart.all.anychart.scales.Geo extendDataRange(Number x, Number y, String var_args) {
     ...
     */
    public com.chart.all.anychart.scales.Geo gap(Number gap) {
...
If the number of ticks is greater than set in maxTicksCount(), the scale calculates from 4 to 6 ticks.
     */
    public com.chart.all.anychart.scales.Geo maxTicksCount(Number count) {
     ...
     */
    public com.chart.all.anychart.scales.Geo maximumX(Number maximumX) {
     ...
     */
    public com.chart.all.anychart.scales.Geo maximumY(Number maximumY) {
     ...
     */
    public com.chart.all.anychart.scales.Geo minimumX(Number minimumX) {
     ...
     */
    public com.chart.all.anychart.scales.Geo minimumY(Number minimumY) {
     ...
     */
    public com.chart.all.anychart.scales.Geo precision(Number[] precision) {
     ...
     */
    public com.chart.all.anychart.scales.Geo precision(Number xPrecision, Number yPrecision) {
     ...
     */
    public com.chart.all.anychart.scales.GeoTicks xMinorTicks() {
        return new com.chart.all.anychart.scales.GeoTicks(jsBase + ".xMinorTicks()");
    }
    /**
     * Setter for the set of scale x minor ticks.
     */
    public com.chart.all.anychart.scales.Geo xMinorTicks(String settings) {
     ...
     */
    public com.chart.all.anychart.scales.GeoTicks xTicks() {
        return new com.chart.all.anychart.scales.GeoTicks(jsBase + ".xTicks()");
    }
    /**
     * Setter for the set of scale x ticks.
     */
    public com.chart.all.anychart.scales.Geo xTicks(String settings) {
     ...
     */
    public com.chart.all.anychart.scales.GeoTicks yMinorTicks() {
        return new com.chart.all.anychart.scales.GeoTicks(jsBase + ".yMinorTicks()");
    }
    /**
     * Setter for the set of scale y minor ticks.
     */
    public com.chart.all.anychart.scales.Geo yMinorTicks(String settings) {
     ...
     */
    public com.chart.all.anychart.scales.GeoTicks yTicks() {
        return new com.chart.all.anychart.scales.GeoTicks(jsBase + ".yTicks()");
    }
    /**
     * Setter for the set of scale y ticks.
     */
    public com.chart.all.anychart.scales.Geo yTicks(String settings) {
