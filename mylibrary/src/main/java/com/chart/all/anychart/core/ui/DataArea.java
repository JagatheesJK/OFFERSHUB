...
public class DataArea extends VisualBase {
     ...
     */
    public com.chart.all.anychart.core.ui.DataArea background(String settings) {
     ...
     * Setter for the data area background.
     */
    public com.chart.all.anychart.core.ui.DataArea background(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.ui.DataArea enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.DataArea zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.ui.DataArea container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.ui.DataArea container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.ui.DataArea container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.DataArea parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.DataArea parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.DataArea parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.DataArea parentBounds(Number left, Number top, Number width, Number height) {
