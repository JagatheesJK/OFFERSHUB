...
public class MACD extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.MACD fastPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base histogramSeries() {
        return new com.chart.all.anychart.core.stock.series.Base(jsBase + ".histogramSeries()");
    }
    /**
     * Setter for the indicator histogram series type.
     */
    public com.chart.all.anychart.core.stock.indicators.MACD histogramSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator histogram series type.
     */
    public com.chart.all.anychart.core.stock.indicators.MACD histogramSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base macdSeries() {
        return new com.chart.all.anychart.core.stock.series.Base(jsBase + ".macdSeries()");
    }
    /**
     * Setter for the indicator MACD series type.
     */
    public com.chart.all.anychart.core.stock.indicators.MACD macdSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator MACD series type.
     */
    public com.chart.all.anychart.core.stock.indicators.MACD macdSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.MACD signalPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base signalSeries() {
        return new com.chart.all.anychart.core.stock.series.Base(jsBase + ".signalSeries()");
    }
    /**
     * Setter for the signal series type.
     */
    public com.chart.all.anychart.core.stock.indicators.MACD signalSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the signal series type.
     */
    public com.chart.all.anychart.core.stock.indicators.MACD signalSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.MACD slowPeriod(Number period) {
