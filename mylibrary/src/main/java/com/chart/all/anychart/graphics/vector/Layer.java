...
<i>Simplified version of {@link anychart.graphics.vector.Layer#addChildAt} where element is added to the end.</i>
     */
    public com.chart.all.anychart.graphics.vector.Layer addChild(Element element) {
...
<img src='/si/8.4.0/anychart.graphics.vector.Layer.addChildAt.png' width='276' height='130'/>
     */
    public com.chart.all.anychart.graphics.vector.Layer addChildAt(Element element, Number index) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer attr(String key, String value) {
...
Read more at {@link anychart.graphics.vector.Circle}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer clip(com.chart.all.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.chart.all.anychart.graphics.vector.Layer clip(String value) {
...
Read more at {@link anychart.graphics.vector.primitives#cross}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer cursor(com.chart.all.anychart.graphics.vector.Cursor value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer desc(String value) {
...
Read more at {@link anychart.graphics.vector.primitives#diamond}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.chart.all.anychart.graphics.vector.Layer disableStrokeScaling(Boolean value) {
...
Read more at {@link anychart.graphics.vector.primitives#donut}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.chart.all.anychart.graphics.vector.Layer drag(com.chart.all.anychart.graphics.math.Rect value) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer getChildAt(Number index) {
...
Read more at {@link anychart.graphics.vector.primitives#hLine}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer id(String id) {
...
You have to take care of used objects yourself.
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer parent(com.chart.all.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.chart.all.anychart.graphics.vector.Layer parent(com.chart.all.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
...
You have to take care of used objects yourself.
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer remove() {
...
<i>This is an extension of {@link anychart.graphics.vector.Layer#removeChildAt} method.</i>
     */
    public com.chart.all.anychart.graphics.vector.Layer removeChild(Element element) {
...
<b>Note:</b> this method doesn't remove element, it just breaks the link between the element and the layer.<br/>
     */
    public com.chart.all.anychart.graphics.vector.Layer removeChildAt(Number index) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer rotateByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Layer rotateByAnchor(Number degrees, String anchor) {
...
Read more at {@link anychart.graphics.vector.primitives#roundedRect}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer scaleByAnchor(Number sx, Number sy, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.chart.all.anychart.graphics.vector.Layer scaleByAnchor(Number sx, Number sy, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer setPosition(Number x, Number y) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Layer setRotationByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Layer setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
...
Read more at {@link anychart.graphics.vector.primitives#star7}
     ...
     * Swaps children.
     */
    public com.chart.all.anychart.graphics.vector.Layer swapChildren(Element element1, Element element2) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer swapChildrenAt(Number index1, Number index2) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer title(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer translate(Number tx, Number ty) {
...
Read more at {@link anychart.graphics.vector.primitives#vLine}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer visible(Boolean isVisible) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Layer zIndex(Number value) {
