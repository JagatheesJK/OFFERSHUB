...
public class StockInteractivity extends Interactivity {
     ...
     */
    public com.chart.all.anychart.core.utils.StockInteractivity multiSelectOnClick(Boolean enabled) {
...
Allows use mouse wheel for scrolling. Press "ctrl" or "shift" and scroll mouse wheel.
     */
    public com.chart.all.anychart.core.utils.StockInteractivity scrollOnMouseWheel(Boolean enabled) {
...
If the value is <b>true<b/>, disables select all points when clicking outside the chart point.
     */
    public com.chart.all.anychart.core.utils.StockInteractivity unselectOnClickOutOfPoint(Boolean enabled) {
...
Allows use mouse wheel for zooming.
     */
    public com.chart.all.anychart.core.utils.StockInteractivity zoomOnMouseWheel(Boolean enabled) {
     ...
     * 
     */
    public com.chart.all.anychart.core.utils.StockInteractivity allowMultiSeriesSelection(Boolean value) {
     ...
     */
    public com.chart.all.anychart.core.utils.StockInteractivity hoverMode(com.chart.all.anychart.enums.HoverMode mode) {
     ...
     * Setter for the hover mode.
     */
    public com.chart.all.anychart.core.utils.StockInteractivity hoverMode(String mode) {
     ...
     */
    public com.chart.all.anychart.core.utils.StockInteractivity selectionMode(com.chart.all.anychart.enums.SelectionMode mode) {
     ...
     * Setter for the selection mode.
     */
    public com.chart.all.anychart.core.utils.StockInteractivity selectionMode(String mode) {
...
<b>Note:</b> Works only with "by-spot" value in the {@link anychart.core.utils.Interactivity#hoverMode} method.
     */
    public com.chart.all.anychart.core.utils.StockInteractivity spotRadius(Number radius) {
