...
public class Table extends Base {
     ...
     * 
     */
    public com.chart.all.anychart.data.Table addData(List<DataEntry> data) {
     ...
     */
    public com.chart.all.anychart.data.TableComputer createComputer(com.chart.all.anychart.data.TableMapping mappingSettingsOrMapping) {
        return new com.chart.all.anychart.data.TableComputer(String.format(Locale.US, jsBase + ".createComputer(%s)", (mappingSettingsOrMapping != null) ? mappingSettingsOrMapping.getJsBase() : null));
    }
    /**
     * 
     */
    public com.chart.all.anychart.data.TableMapping mapAs(String mapping) {
        return new com.chart.all.anychart.data.TableMapping(String.format(Locale.US, jsBase + ".mapAs(%s)", wrapQuotes(mapping)));
    }
    /**
     * Removes all items between a start and end keys.
     */
    public com.chart.all.anychart.data.Table remove(Number startKey, Number endKey) {
     ...
     * Removes all items between a start and end keys.
     */
    public com.chart.all.anychart.data.Table remove(Number startKey, String endKey) {
     ...
     * Removes all items between a start and end keys.
     */
    public com.chart.all.anychart.data.Table remove(String startKey, Number endKey) {
     ...
     * Removes all items between a start and end keys.
     */
    public com.chart.all.anychart.data.Table remove(String startKey, String endKey) {
     ...
     */
    public com.chart.all.anychart.data.Table removeFirst(Number count) {
