...
public class Linear extends ScatterBase {
     ...
     */
    public com.chart.all.anychart.scales.Linear alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public com.chart.all.anychart.scales.Linear alignMinimum(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.Linear compareWith(com.chart.all.anychart.enums.ScaleCompareWithMode mode) {
     ...
     * Setter for the date which should be used as a changes zero for series.
     */
    public com.chart.all.anychart.scales.Linear compareWith(String mode) {
     ...
     * Setter for the date which should be used as a changes zero for series.
     */
    public com.chart.all.anychart.scales.Linear compareWith(Number mode) {
     ...
     */
    public com.chart.all.anychart.scales.Linear comparisonMode(com.chart.all.anychart.enums.ScaleComparisonMode mode) {
     ...
     * Setter for the scale changes mode.
     */
    public com.chart.all.anychart.scales.Linear comparisonMode(String mode) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public com.chart.all.anychart.scales.Linear extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public com.chart.all.anychart.scales.Linear inverted(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.Linear maximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.Linear maximumGap(Number gap) {
     ...
     */
    public com.chart.all.anychart.scales.Linear minimum(Number minimum) {
     ...
     */
    public com.chart.all.anychart.scales.Linear minimumGap(Number gap) {
     ...
     */
    public com.chart.all.anychart.scales.Linear minorTicks(String settings) {
     ...
     */
    public com.chart.all.anychart.scales.Linear softMaximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.Linear softMinimum(Number minimum) {
     ...
     */
    public com.chart.all.anychart.scales.Linear stackDirection(com.chart.all.anychart.enums.ScaleStackDirection direction) {
     ...
     * Setter for the stacking direction.
     */
    public com.chart.all.anychart.scales.Linear stackDirection(String direction) {
     ...
     */
    public com.chart.all.anychart.scales.Linear stackMode(com.chart.all.anychart.enums.ScaleStackMode value) {
     ...
     * Setter for the stacked mode.
     */
    public com.chart.all.anychart.scales.Linear stackMode(String value) {
...
call of this method if needed.
     */
    public com.chart.all.anychart.scales.Linear startAutoCalc() {
...
Flag to stick to zero value on auto calc if gaps lead to zero crossing.
     */
    public com.chart.all.anychart.scales.Linear stickToZero(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.Linear ticks(String settings) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public com.chart.all.anychart.scales.Linear maxTicksCount(Number count) {
