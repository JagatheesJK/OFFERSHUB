...
public class AMA extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.AMA fastPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.AMA period(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.AMA series(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator series type.
     */
    public com.chart.all.anychart.core.stock.indicators.AMA series(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.AMA slowPeriod(Number period) {
