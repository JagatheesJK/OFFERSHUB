...
public class Traverser extends JsObject {
     ...
     */
    public com.chart.all.anychart.data.tree.DataItem current() {
        return new com.chart.all.anychart.data.tree.DataItem(jsBase + ".current()");
    }
    /**
...
<img src='/si/8.4.0/anychart.data.Traverser.reset.png' height='296' width='372'/>
     */
    public com.chart.all.anychart.data.Traverser reset() {
     ...
     */
    public com.chart.all.anychart.data.Traverser set(String key, String value) {
