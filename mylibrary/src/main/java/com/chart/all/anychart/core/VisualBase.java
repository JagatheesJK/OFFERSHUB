...
public class VisualBase extends Base {
     ...
     */
    public com.chart.all.anychart.core.VisualBase container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.VisualBase container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.VisualBase container(String element) {
     ...
     */
    public com.chart.all.anychart.core.VisualBase enabled(Boolean enabled) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.VisualBase parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.VisualBase parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.VisualBase parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.VisualBase parentBounds(Number left, Number top, Number width, Number height) {
     ...
     */
    public com.chart.all.anychart.core.VisualBase zIndex(Number zIndex) {
