...
public class LinearColor extends ScatterBase {
     ...
     */
    public com.chart.all.anychart.scales.LinearColor colors(String var_args) {
     ...
     * Setter for the linear gradient for the linear color scale.
     */
    public com.chart.all.anychart.scales.LinearColor colors(com.chart.all.anychart.graphics.vector.SolidFill var_args) {
     ...
     * Setter for the linear gradient for the linear color scale.
     */
    public com.chart.all.anychart.scales.LinearColor colors(com.chart.all.anychart.graphics.vector.LinearGradientFill var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colors(%s);", (var_args != null) ? var_args.getJsBase() : null));
     ...
     * Setter for the linear gradient for the linear color scale.
     */
    public com.chart.all.anychart.scales.LinearColor colors(com.chart.all.anychart.graphics.vector.RadialGradientFill var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colors(%s);", (var_args != null) ? var_args.getJsBase() : null));
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public com.chart.all.anychart.scales.LinearColor extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public com.chart.all.anychart.scales.LinearColor inverted(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.LinearColor maximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.LinearColor minimum(Number minimum) {
     ...
     */
    public com.chart.all.anychart.scales.LinearColor minorTicks(String ticks) {
...
call of this method if needed.
     */
    public com.chart.all.anychart.scales.LinearColor startAutoCalc() {
     ...
     */
    public com.chart.all.anychart.scales.LinearColor ticks(String ticks) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public com.chart.all.anychart.scales.LinearColor alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public com.chart.all.anychart.scales.LinearColor alignMinimum(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.LinearColor maxTicksCount(Number count) {
