...
public class MapPoint extends Point {
     ...
     */
    public com.chart.all.anychart.core.SeparateChart getCurrentChart() {
        return new com.chart.all.anychart.core.SeparateChart(jsBase + ".getCurrentChart()");
    }
    /**
     ...
     */
    public com.chart.all.anychart.core.SeparateChart getParentChart() {
        return new com.chart.all.anychart.core.SeparateChart(jsBase + ".getParentChart()");
    }
    /**
     ...
     */
    public com.chart.all.anychart.core.MapPoint hovered(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.MapPoint selected(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.MapPoint set(String field, String value) {
