...
public class SideControl extends Base {
     ...
     */
    public com.chart.all.anychart.core.gantt.edit.Thumb connectorThumb() {
        return new com.chart.all.anychart.core.gantt.edit.Thumb(jsBase + ".connectorThumb()");
    }
    /**
...
The connector thumb is a circle on the task that allows creating connector from one task to another.
     */
    public com.chart.all.anychart.core.gantt.edit.SideControl connectorThumb(String settings) {
     ...
     */
    public com.chart.all.anychart.core.gantt.edit.Thumb thumb() {
        return new com.chart.all.anychart.core.gantt.edit.Thumb(jsBase + ".thumb()");
    }
    /**
     * Setter for the thumb settings.<br/>
Thumb is a rectangle on the task that allows editing the interval of the task.
     */
    public com.chart.all.anychart.core.gantt.edit.SideControl thumb(String settings) {
