...
public class SeriesA11y extends A11y {
     ...
     */
    public com.chart.all.anychart.core.utils.SeriesA11y enabled(Boolean enabled) {
...
{docs:Common_Settings/Text_Formatters}Learn more about using titleFormat() method.{docs}
     */
    public com.chart.all.anychart.core.utils.SeriesA11y titleFormat(String formatSettings) {
