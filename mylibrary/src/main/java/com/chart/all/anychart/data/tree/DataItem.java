package com.chart.all.anychart.data.tree;
...
public class DataItem extends JsObject {
     ...
     * Adds a child.
     */
    public com.chart.all.anychart.data.tree.DataItem addChild(com.chart.all.anychart.data.tree.DataItem child) {
...
Please make sure that child has not inner cycles to avoid stack overflow exception.
     ...
     */
    public com.chart.all.anychart.data.tree.DataItem del(String var_args) {
     ...
     */
    public com.chart.all.anychart.data.tree.DataItem getParent() {
     ...
     * Removes data item.
     */
    public com.chart.all.anychart.data.tree.DataItem remove() {
     ...
     * Removes children.
     */
    public com.chart.all.anychart.data.tree.DataItem removeChildren() {
     ...
     */
    public com.chart.all.anychart.data.tree.DataItem set(String var_args) {
