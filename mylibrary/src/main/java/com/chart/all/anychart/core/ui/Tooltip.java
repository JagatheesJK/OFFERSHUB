...
public class Tooltip extends VisualBase {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip adjustFontSize(Boolean adjustOrAdjustByWidth, Boolean adjustByHeight) {
     ...
     * Setter for the adjusting font size.
     */
    public com.chart.all.anychart.core.ui.Tooltip adjustFontSize(String adjustOrAdjustByWidth, Boolean adjustByHeight) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip allowLeaveChart(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip allowLeaveScreen(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip allowLeaveStage(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip anchor(com.chart.all.anychart.enums.Anchor anchor) {
     ...
     * Setter for the tooltip anchor.
     */
    public com.chart.all.anychart.core.ui.Tooltip anchor(String anchor) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip background(Boolean settings) {
     ...
     * Setter for tooltip background settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip background(String settings) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip disablePointerEvents(Boolean enabled) {
...
<b>Note</b>: Works only for the <b>chart</b> tooltip.
     */
    public com.chart.all.anychart.core.ui.Tooltip displayMode(com.chart.all.anychart.enums.TooltipDisplayMode value) {
...
<b>Note</b>: Works only for the <b>chart</b> tooltip.
     */
    public com.chart.all.anychart.core.ui.Tooltip displayMode(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip fontColor(String color) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip fontDecoration(com.chart.all.anychart.graphics.vector.text.Decoration value) {
     ...
     * Setter for font decoration settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip fontDecoration(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip fontFamily(String family) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip fontOpacity(Number opacity) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip fontSize(Number size) {
     ...
     * Setter for font size settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip fontSize(String size) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip fontStyle(String style) {
     ...
     * Setter for font style settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip fontStyle(com.chart.all.anychart.graphics.vector.text.FontStyle style) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip fontVariant(String value) {
     ...
     * Setter for font variant settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip fontVariant(com.chart.all.anychart.graphics.vector.text.FontVariant value) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip fontWeight(String weight) {
     ...
     * Setter for font weight settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip fontWeight(Number weight) {
...
{docs:Common_Settings/Text_Formatters}Learn more about using the format() method.{docs}
     */
    public com.chart.all.anychart.core.ui.Tooltip format(String format) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip hAlign(String align) {
     ...
     * Setter for the text horizontal align settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip hAlign(com.chart.all.anychart.graphics.vector.text.HAlign align) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip height(String height) {
     ...
     * Setter for the tooltip height.
     */
    public com.chart.all.anychart.core.ui.Tooltip height(Number height) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip hideDelay(Number delay) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip letterSpacing(Number spacing) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip lineHeight(Number height) {
     ...
     * Setter for text line height settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip lineHeight(String height) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip maxFontSize(Number size) {
     ...
     * Setter for maximum font size settings for adjust text from.
     */
    public com.chart.all.anychart.core.ui.Tooltip maxFontSize(String size) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip minFontSize(Number size) {
     ...
     * Setter for minimum font size settings for adjust text from.
     */
    public com.chart.all.anychart.core.ui.Tooltip minFontSize(String size) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip offsetX(Number offset) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip offsetY(Number offset) {
...
See the structure of HTML-tooltip elements in the {api:anychart.core.ui.Tooltip#useHtml}useHtml() method{api}.
     */
    public com.chart.all.anychart.core.ui.Tooltip onContentChanged(String handler) {
...
See the structure of HTML-tooltip elements in the {api:anychart.core.ui.Tooltip#useHtml}useHtml() method{api}.
     */
    public com.chart.all.anychart.core.ui.Tooltip onDomReady(String handler) {
...
See the structure of HTML-tooltip elements in the {api:anychart.core.ui.Tooltip#useHtml}useHtml() method{api}.
     */
    public com.chart.all.anychart.core.ui.Tooltip onTitleChanged(String handler) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number[] padding) {
     ...
     * Setter for the tooltip padding in pixels by one value.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String[] padding) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the tooltip padding in pixels.
     */
    public com.chart.all.anychart.core.ui.Tooltip padding(Number value1, Number value2, Number value3, Number value4) {
...
<b>Note:</b> Do not works with position mode <b>FLOAT</b>.
     */
    public com.chart.all.anychart.core.ui.Tooltip position(com.chart.all.anychart.enums.Position position) {
...
<b>Note:</b> Do not works with position mode <b>FLOAT</b>.
     */
    public com.chart.all.anychart.core.ui.Tooltip position(String position) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip positionMode(com.chart.all.anychart.enums.TooltipPositionMode mode) {
     ...
     * Setter for all tooltips position mode.
     */
    public com.chart.all.anychart.core.ui.Tooltip positionMode(String mode) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip selectable(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.Separator separator() {
        return new com.chart.all.anychart.core.ui.Separator(jsBase + ".separator()");
    }
    /**
     * Setter for the union tooltip separator.
     */
    public com.chart.all.anychart.core.ui.Tooltip separator(Boolean settings) {
     ...
     * Setter for the union tooltip separator.
     */
    public com.chart.all.anychart.core.ui.Tooltip separator(String settings) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip textDirection(String value) {
     ...
     * Setter for text direction settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip textDirection(com.chart.all.anychart.graphics.vector.text.Direction value) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip textIndent(Number indent) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip textOverflow(com.chart.all.anychart.graphics.vector.text.TextOverflow value) {
     ...
     * Setter for text overflow settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip textOverflow(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip textSettings(String settings) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip textSettings(String name, String value) {
     ...
     * Setter for the custom text appearance settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip textSettings(String name, Number value) {
     ...
     * Setter for the custom text appearance settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip textSettings(String name, Boolean value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".textSettings(%s, %s);", wrapQuotes(name), value));
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip title(Boolean settings) {
     ...
     * Setter for union tooltip title visual settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip title(String settings) {
...
<b>Note:</b> Use {@link anychart.core.ui.Tooltip#title} method to set title visual settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip titleFormat(String format) {
...
{docs:Common_Settings/Text_Formatters}Learn more about using unionFormat() method.{docs}
     */
    public com.chart.all.anychart.core.ui.Tooltip unionFormat(String unionFormat) {
...
The HTML text obtained from {api:anychart.core.ui.Tooltip#titleFormat}tooltip.titleFormat(){api} is rendered to the tltleElement.
     */
    public com.chart.all.anychart.core.ui.Tooltip useHtml(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip vAlign(String align) {
     ...
     * Setter for text vertical align settings.
     */
    public com.chart.all.anychart.core.ui.Tooltip vAlign(com.chart.all.anychart.graphics.vector.text.VAlign align) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip valuePostfix(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip valuePrefix(String value) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip width(String width) {
     ...
     * Setter for the tooltip width.
     */
    public com.chart.all.anychart.core.ui.Tooltip width(Number width) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip wordBreak(com.chart.all.anychart.enums.WordBreak mode) {
     ...
     * Setter for the word-break mode.
     */
    public com.chart.all.anychart.core.ui.Tooltip wordBreak(String mode) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip wordWrap(com.chart.all.anychart.enums.WordWrap mode) {
     ...
     * Setter for the word-wrap mode.
     */
    public com.chart.all.anychart.core.ui.Tooltip wordWrap(String mode) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.ui.Tooltip container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.ui.Tooltip container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.ui.Tooltip container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.Tooltip parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.Tooltip parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.Tooltip parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.ui.Tooltip parentBounds(Number left, Number top, Number width, Number height) {
