...
<b>Note</b>: Works only after chart.draw() is called.
     ...
     */
    public com.chart.all.anychart.core.BubblePoint hovered(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.BubblePoint selected(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.BubblePoint set(String field, String value) {
