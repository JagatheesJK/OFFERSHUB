...
import com.chart.all.anychart.graphics.vector.PatternFill;
...
<i>Simplified version of {@link anychart.graphics.vector.Layer#addChildAt} where element is added to the end.</i>
     */
    public com.chart.all.anychart.graphics.vector.HatchFill addChild(com.chart.all.anychart.graphics.vector.Element element) {
...
<img src='/si/8.4.0/anychart.graphics.vector.Layer.addChildAt.png' width='276' height='130'/>
     */
    public com.chart.all.anychart.graphics.vector.HatchFill addChildAt(com.chart.all.anychart.graphics.vector.Element element, Number index) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill attr(String key, String value) {
...
Read more at {@link anychart.graphics.vector.Circle}
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill clip(com.chart.all.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill clip(String value) {
...
Read more at {@link anychart.graphics.vector.primitives#cross}
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill cursor(com.chart.all.anychart.graphics.vector.Cursor value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill desc(String value) {
...
Read more at {@link anychart.graphics.vector.primitives#diamond}
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill disableStrokeScaling(Boolean value) {
...
Read more at {@link anychart.graphics.vector.primitives#donut}
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill drag(com.chart.all.anychart.graphics.math.Rect value) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill getChildAt(Number index) {
...
Read more at {@link anychart.graphics.vector.primitives#hLine}
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill id(String id) {
...
You have to take care of used objects yourself.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill layer() {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill parent() {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill parent(com.chart.all.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill parent(com.chart.all.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
...
You have to take care of used objects yourself.
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill remove() {
...
<i>This is an extension of {@link anychart.graphics.vector.Layer#removeChildAt} method.</i>
     */
    public com.chart.all.anychart.graphics.vector.HatchFill removeChild(com.chart.all.anychart.graphics.vector.Element element) {
...
<b>Note:</b> this method doesn't remove element, it just breaks the link between the element and the layer.<br/>
     */
    public com.chart.all.anychart.graphics.vector.HatchFill removeChildAt(Number index) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill rotateByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill rotateByAnchor(Number degrees, String anchor) {
...
Read more at {@link anychart.graphics.vector.primitives#roundedRect}
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill scaleByAnchor(Number sx, Number sy, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill scaleByAnchor(Number sx, Number sy, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill setPosition(Number x, Number y) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill setRotationByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
...
Read more at {@link anychart.graphics.vector.primitives#star7}
     ...
     * Swaps children.
     */
    public com.chart.all.anychart.graphics.vector.HatchFill swapChildren(com.chart.all.anychart.graphics.vector.Element element1, com.chart.all.anychart.graphics.vector.Element element2) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill swapChildrenAt(Number index1, Number index2) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill title(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill translate(Number tx, Number ty) {
...
Read more at {@link anychart.graphics.vector.primitives#vLine}
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill visible(Boolean isVisible) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.HatchFill zIndex(Number value) {
