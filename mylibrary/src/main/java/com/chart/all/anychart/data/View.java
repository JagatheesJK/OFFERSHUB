...
public class View extends Base {
     ...
     */
    public com.chart.all.anychart.data.View concat(com.chart.all.anychart.data.View otherView) {
     ...
     * Concatenates two views to make a derived view that contains rows from both views.
     */
    public com.chart.all.anychart.data.View concat(String[] otherView) {
     ...
     */
    public com.chart.all.anychart.data.View derive() {
...
Learn how it works at {@link anychart.data.Iterator#meta}.
     ...
     */
    public com.chart.all.anychart.data.View meta(Number index, String name, String value) {
     ...
     */
    public com.chart.all.anychart.data.View set(Number rowIndex, String fieldName, String value) {
     ...
     */
    public com.chart.all.anychart.data.View sort(String fieldName, com.chart.all.anychart.enums.Sort order) {
     ...
     * Creates a derived view that ensures sorting by a passed field.
     */
    public com.chart.all.anychart.data.View sort(String fieldName, String order) {
