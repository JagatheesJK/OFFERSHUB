...
public class Legend extends JsObject {
     ...
     */
    public com.chart.all.anychart.standalones.Legend align(com.chart.all.anychart.enums.Align align) {
     ...
     * Setter for legend align settings.
     */
    public com.chart.all.anychart.standalones.Legend align(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend background(String settings) {
     ...
     * Setter for the legend background.
     */
    public com.chart.all.anychart.standalones.Legend background(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the legend container.
     */
    public com.chart.all.anychart.standalones.Legend container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.standalones.Legend disablePointerEvents(Boolean enabled) {
     ...
     * Draws legend.
     */
    public com.chart.all.anychart.standalones.Legend draw() {
     ...
     */
    public com.chart.all.anychart.standalones.Legend enabled(Boolean enabled) {
...
{@link https://www.w3schools.com/html/html_colors.asp}
     */
    public com.chart.all.anychart.standalones.Legend fontColor(String color) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend fontDecoration(com.chart.all.anychart.graphics.vector.text.Decoration value) {
     ...
     * Setter for the text font decoration.
     */
    public com.chart.all.anychart.standalones.Legend fontDecoration(String value) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend fontFamily(String family) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend fontOpacity(Number opacity) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend fontSize(String size) {
     ...
     * Setter for the text font size.
     */
    public com.chart.all.anychart.standalones.Legend fontSize(Number size) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend fontStyle(com.chart.all.anychart.graphics.vector.text.FontStyle style) {
     ...
     * Setter for the text font style.
     */
    public com.chart.all.anychart.standalones.Legend fontStyle(String style) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend fontVariant(com.chart.all.anychart.graphics.vector.text.FontVariant value) {
     ...
     * Setter for the text font variant.
     */
    public com.chart.all.anychart.standalones.Legend fontVariant(String value) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.standalones.Legend fontWeight(String weight) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.standalones.Legend fontWeight(Number weight) {
     ...
     */
    public com.chart.all.anychart.math.Rect getRemainingBounds() {
        return new com.chart.all.anychart.math.Rect(jsBase + ".getRemainingBounds()");
    }
    /**
     ...
     */
    public com.chart.all.anychart.standalones.Legend hAlign(com.chart.all.anychart.graphics.vector.text.HAlign align) {
     ...
     * Setter for the text horizontal align.
     */
    public com.chart.all.anychart.standalones.Legend hAlign(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend height(Number height) {
     ...
     * Setter for the legend height.
     */
    public com.chart.all.anychart.standalones.Legend height(String height) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend hoverCursor(com.chart.all.anychart.enums.Cursor cursorTypr) {
     ...
     * Setter for hover cursor settings.
     */
    public com.chart.all.anychart.standalones.Legend hoverCursor(String cursorTypr) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend iconSize(Number size) {
     ...
     * Setter for the icon size.
     */
    public com.chart.all.anychart.standalones.Legend iconSize(String size) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend iconTextSpacing(String spacing) {
     ...
     * Setter for spacing between icon and text in a legend item.
     */
    public com.chart.all.anychart.standalones.Legend iconTextSpacing(Number spacing) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend inverted(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend items(com.chart.all.anychart.core.ui.legend.LegendItemProvider[] itemsList) {
...
{docs:Stock_Charts/Legend#items}Learn more about using itemsFormat() method.{docs}
     */
    public com.chart.all.anychart.standalones.Legend itemsFormat(String format) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend itemsFormatter(com.chart.all.anychart.core.ui.legend.LegendItemProvider[] formatterFunction) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend itemsLayout(com.chart.all.anychart.enums.LegendLayout layout) {
     ...
     * Setter for items layout.
     */
    public com.chart.all.anychart.standalones.Legend itemsLayout(String layout) {
     ...
     */
    public com.chart.all.anychart.core.SeparateChart itemsSource() {
        return new com.chart.all.anychart.core.SeparateChart(jsBase + ".itemsSource()");
    }
    /**
     * Setter for items source.
     */
    public com.chart.all.anychart.standalones.Legend itemsSource(com.chart.all.anychart.core.SeparateChart source) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend itemsSourceMode(com.chart.all.anychart.enums.LegendItemsSourceMode mode) {
     ...
     * Setter for items source mode.
     */
    public com.chart.all.anychart.standalones.Legend itemsSourceMode(String mode) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend itemsSpacing(String spacing) {
     ...
     * Setter for items spacing settings.
     */
    public com.chart.all.anychart.standalones.Legend itemsSpacing(Number spacing) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.standalones.Legend letterSpacing(String spacing) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.standalones.Legend letterSpacing(Number spacing) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.standalones.Legend lineHeight(String height) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.standalones.Legend lineHeight(Number height) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend margin(Number[] margin) {
     ...
     * Setter for the legend margin in pixels using a single value.
     */
    public com.chart.all.anychart.standalones.Legend margin(String[] margin) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend margin(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the legend margin in pixels using a single simple values.
     */
    public com.chart.all.anychart.standalones.Legend margin(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend padding(Number[] padding) {
     ...
     * Setter for the legend padding in pixels using a single value.
     */
    public com.chart.all.anychart.standalones.Legend padding(String[] padding) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend padding(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the legend padding setting in pixels using a several value.
     */
    public com.chart.all.anychart.standalones.Legend padding(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.chart.all.anychart.core.ui.Paginator paginator() {
        return new com.chart.all.anychart.core.ui.Paginator(jsBase + ".paginator()");
    }
    /**
     * Setter for paginator settings.
     */
    public com.chart.all.anychart.standalones.Legend paginator(String settings) {
     ...
     * Setter for paginator settings.
     */
    public com.chart.all.anychart.standalones.Legend paginator(Boolean settings) {
...
As a getter falls back to stage bounds.
     ...
     */
    public com.chart.all.anychart.standalones.Legend parentBounds(com.chart.all.anychart.math.Rect bounds) {
     ...
     * Setter for bounds using single value.
     */
    public com.chart.all.anychart.standalones.Legend parentBounds(String bounds) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend parentBounds(Number left, Number top, Number width, Number height) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend position(com.chart.all.anychart.enums.Orientation position) {
     ...
     * Setter for legend position setting.
     */
    public com.chart.all.anychart.standalones.Legend position(String position) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend selectable(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend textDirection(com.chart.all.anychart.graphics.vector.text.Direction direction) {
     ...
     * Setter for the text direction.
     */
    public com.chart.all.anychart.standalones.Legend textDirection(String direction) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend textIndent(Number indent) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend textOverflow(com.chart.all.anychart.graphics.vector.text.TextOverflow value) {
     ...
     * Setter for the text overflow settings.
     */
    public com.chart.all.anychart.standalones.Legend textOverflow(String value) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend textSettings(String name, String settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.standalones.Legend textSettings(String name, Number settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.standalones.Legend textSettings(String name, Boolean settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".textSettings(%s, %s);", wrapQuotes(name), settings));
     ...
     */
    public com.chart.all.anychart.standalones.Legend title(Boolean settings) {
     ...
     * Setter for the legend title.
     */
    public com.chart.all.anychart.standalones.Legend title(String settings) {
...
{docs:Common_Settings/Text_Formatters}Learn more about using titleFormat() method.{docs}
     */
    public com.chart.all.anychart.standalones.Legend titleFormat(String format) {
     ...
     */
    public com.chart.all.anychart.core.ui.Separator titleSeparator() {
        return new com.chart.all.anychart.core.ui.Separator(jsBase + ".titleSeparator()");
    }
    /**
     * Setter for title separator settings.
     */
    public com.chart.all.anychart.standalones.Legend titleSeparator(String settings) {
     ...
     * Setter for title separator settings.
     */
    public com.chart.all.anychart.standalones.Legend titleSeparator(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend tooltip(String settings) {
     ...
     * Setter for legend tooltip.
     */
    public com.chart.all.anychart.standalones.Legend tooltip(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend useHtml(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend vAlign(com.chart.all.anychart.graphics.vector.text.VAlign align) {
     ...
     * Setter for the text vertical align.
     */
    public com.chart.all.anychart.standalones.Legend vAlign(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend width(Number width) {
     ...
     * Setter for the legend width.
     */
    public com.chart.all.anychart.standalones.Legend width(String width) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend wordBreak(com.chart.all.anychart.enums.WordBreak mode) {
     ...
     * Setter for the word-break mode.
     */
    public com.chart.all.anychart.standalones.Legend wordBreak(String mode) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend wordWrap(com.chart.all.anychart.enums.WordWrap mode) {
     ...
     * Setter for the word-wrap mode.
     */
    public com.chart.all.anychart.standalones.Legend wordWrap(String mode) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend drag(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.chart.all.anychart.standalones.Legend maxHeight(String height) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.chart.all.anychart.standalones.Legend maxWidth(String width) {
     ...
     */
    public com.chart.all.anychart.standalones.Legend positionMode(com.chart.all.anychart.enums.LegendPositionMode mode) {
     ...
     * Setter for the position mode.
     */
    public com.chart.all.anychart.standalones.Legend positionMode(String mode) {
