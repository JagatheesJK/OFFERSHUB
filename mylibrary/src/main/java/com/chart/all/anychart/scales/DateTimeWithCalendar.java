package com.chart.all.anychart.scales;
...
import com.chart.all.anychart.scales.ScatterBase;
...
public class DateTimeWithCalendar extends ScatterBase {
     ...
     * 
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar calendar(com.chart.all.anychart.scales.Calendar calendar) {
     ...
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar count(Number count) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar extendDataRange(String var_args) {
...
with a passed interval. Ticks fill space from the fromPix pixel to the toPix pixel (if available).
     */
    public void getTicks(Number fromPix, Number toPix, com.chart.all.anychart.enums.Interval unit, Number count) {
...
instead of bottom-to-top and left-to-right.
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar inverted(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar maximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.DateTime maximumGap(Number gap) {
        return new com.chart.all.anychart.scales.DateTime(String.format(Locale.US, jsBase + ".maximumGap(%s)", gap));
    }
    /**
     ...
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar minimum(Number minimum) {
     ...
     */
    public com.chart.all.anychart.scales.DateTime minimumGap(Number gap) {
        return new com.chart.all.anychart.scales.DateTime(String.format(Locale.US, jsBase + ".minimumGap(%s)", gap));
    }
    /**
     ...
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar skipHolidays(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.DateTime softMaximum(Number maximum) {
        return new com.chart.all.anychart.scales.DateTime(String.format(Locale.US, jsBase + ".softMaximum(%s)", maximum));
    }
    /**
     ...
     */
    public com.chart.all.anychart.scales.DateTime softMinimum(Number minimum) {
        return new com.chart.all.anychart.scales.DateTime(String.format(Locale.US, jsBase + ".softMinimum(%s)", minimum));
    }
    /**
     * Informs scale that an auto-range calculation started for the chart, so it should reset its data range on the first
call of this method if needed.
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar startAutoCalc() {
     ...
     * 
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar startDate(Number date) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar unit(com.chart.all.anychart.enums.Interval interval) {
     ...
     * Setter for the unit interval.
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar unit(String interval) {
     ...
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar unitPixSize(Number size) {
     ...
     * Setter for the unit size.
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar unitPixSize(String size) {
     ...
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar alignMinimum(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.DateTimeWithCalendar maxTicksCount(Number count) {
