package com.chart.all.anychart.data.treeview;
...
public class DataItem extends JsObject {
     ...
     */
    public com.chart.all.anychart.data.treeview.DataItem del(String var_args) {
     ...
     */
    public com.chart.all.anychart.data.treeview.DataItem getParent() {
     ...
     * Removes data item.
     */
    public com.chart.all.anychart.data.treeview.DataItem remove() {
     ...
     * Removes children.
     */
    public com.chart.all.anychart.data.treeview.DataItem removeChildren() {
     ...
     */
    public com.chart.all.anychart.data.treeview.DataItem set(String var_args) {
