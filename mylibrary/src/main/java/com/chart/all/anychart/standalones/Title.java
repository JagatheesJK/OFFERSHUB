...
public class Title extends JsObject {
     ...
     */
    public com.chart.all.anychart.standalones.Title align(com.chart.all.anychart.enums.Align align) {
     ...
     * Setter for the title align.
     */
    public com.chart.all.anychart.standalones.Title align(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.Title background(String settings) {
     ...
     * Setter for the title background.
     */
    public com.chart.all.anychart.standalones.Title background(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.standalones.Title container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the title container.
     */
    public com.chart.all.anychart.standalones.Title container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.standalones.Title disablePointerEvents(Boolean enabled) {
     ...
     * Draws title.
     */
    public com.chart.all.anychart.standalones.Title draw() {
     ...
     */
    public com.chart.all.anychart.standalones.Title enabled(Boolean enabled) {
...
{@link https://www.w3schools.com/html/html_colors.asp}
     */
    public com.chart.all.anychart.standalones.Title fontColor(String color) {
     ...
     */
    public com.chart.all.anychart.standalones.Title fontDecoration(com.chart.all.anychart.graphics.vector.text.Decoration value) {
     ...
     * Setter for the text font decoration.
     */
    public com.chart.all.anychart.standalones.Title fontDecoration(String value) {
     ...
     */
    public com.chart.all.anychart.standalones.Title fontFamily(String family) {
     ...
     */
    public com.chart.all.anychart.standalones.Title fontOpacity(Number opacity) {
     ...
     */
    public com.chart.all.anychart.standalones.Title fontSize(String size) {
     ...
     * Setter for the text font size.
     */
    public com.chart.all.anychart.standalones.Title fontSize(Number size) {
     ...
     */
    public com.chart.all.anychart.standalones.Title fontStyle(com.chart.all.anychart.graphics.vector.text.FontStyle style) {
     ...
     * Setter for the text font style.
     */
    public com.chart.all.anychart.standalones.Title fontStyle(String style) {
     ...
     */
    public com.chart.all.anychart.standalones.Title fontVariant(com.chart.all.anychart.graphics.vector.text.FontVariant value) {
     ...
     * Setter for the text font variant.
     */
    public com.chart.all.anychart.standalones.Title fontVariant(String value) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.standalones.Title fontWeight(String weight) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.standalones.Title fontWeight(Number weight) {
     ...
     */
    public com.chart.all.anychart.standalones.Title hAlign(com.chart.all.anychart.graphics.vector.text.HAlign align) {
     ...
     * Setter for the text horizontal align.
     */
    public com.chart.all.anychart.standalones.Title hAlign(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.Title height(Number height) {
     ...
     * Setter for the title height.
     */
    public com.chart.all.anychart.standalones.Title height(String height) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.standalones.Title letterSpacing(String spacing) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.standalones.Title letterSpacing(Number spacing) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.standalones.Title lineHeight(String height) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.standalones.Title lineHeight(Number height) {
...
Learn more about margins at {@link anychart.core.Chart#margin}.
     ...
     */
    public com.chart.all.anychart.standalones.Title margin(String allValues) {
     ...
     * Setter for the title margin in pixels using one complex value.
     */
    public com.chart.all.anychart.standalones.Title margin(Number allValues) {
     ...
     */
    public com.chart.all.anychart.standalones.Title margin(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the title margin in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title margin(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.chart.all.anychart.standalones.Title orientation(com.chart.all.anychart.enums.Orientation orientation) {
     ...
     * Setter for the title orientation.
     */
    public com.chart.all.anychart.standalones.Title orientation(String orientation) {
...
Learn more about paddings at {@link anychart.core.Chart#padding}.
     ...
     */
    public com.chart.all.anychart.standalones.Title padding(String paddinge) {
     ...
     * Setter for the title padding in pixels using single value.
     */
    public com.chart.all.anychart.standalones.Title padding(Number paddinge) {
     ...
     */
    public com.chart.all.anychart.standalones.Title padding(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the title padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.Title padding(Number value1, Number value2, Number value3, Number value4) {
...
As a getter falls back to stage bounds.
     ...
     */
    public com.chart.all.anychart.standalones.Title parentBounds(com.chart.all.anychart.math.Rect bounds) {
     ...
     * Setter for bounds using single value.
     */
    public com.chart.all.anychart.standalones.Title parentBounds(String bounds) {
     ...
     */
    public com.chart.all.anychart.standalones.Title parentBounds(Number left, Number top, Number width, Number height) {
     ...
     */
    public com.chart.all.anychart.standalones.Title rotation(Number rotation) {
     ...
     */
    public com.chart.all.anychart.standalones.Title selectable(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.Title text(String text) {
     ...
     */
    public com.chart.all.anychart.standalones.Title textDirection(com.chart.all.anychart.graphics.vector.text.Direction direction) {
     ...
     * Setter for the text direction.
     */
    public com.chart.all.anychart.standalones.Title textDirection(String direction) {
     ...
     */
    public com.chart.all.anychart.standalones.Title textIndent(Number indent) {
     ...
     */
    public com.chart.all.anychart.standalones.Title textOverflow(com.chart.all.anychart.graphics.vector.text.TextOverflow value) {
     ...
     * Setter for the text overflow settings.
     */
    public com.chart.all.anychart.standalones.Title textOverflow(String value) {
     ...
     */
    public com.chart.all.anychart.standalones.Title textSettings(String name, String settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.standalones.Title textSettings(String name, Number settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.standalones.Title textSettings(String name, Boolean settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".textSettings(%s, %s);", wrapQuotes(name), settings));
     ...
     */
    public com.chart.all.anychart.standalones.Title useHtml(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.Title vAlign(com.chart.all.anychart.graphics.vector.text.VAlign align) {
     ...
     * Setter for the text vertical align.
     */
    public com.chart.all.anychart.standalones.Title vAlign(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.Title width(Number width) {
     ...
     * Setter for the title width.
     */
    public com.chart.all.anychart.standalones.Title width(String width) {
     ...
     */
    public com.chart.all.anychart.standalones.Title wordBreak(com.chart.all.anychart.enums.WordBreak mode) {
     ...
     * Setter for the word-break mode.
     */
    public com.chart.all.anychart.standalones.Title wordBreak(String mode) {
     ...
     */
    public com.chart.all.anychart.standalones.Title wordWrap(com.chart.all.anychart.enums.WordWrap mode) {
     ...
     * Setter for the word-wrap mode.
     */
    public com.chart.all.anychart.standalones.Title wordWrap(String mode) {
     ...
     */
    public com.chart.all.anychart.standalones.Title zIndex(Number zIndex) {
