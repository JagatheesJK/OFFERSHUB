...
public class Image extends Element {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image align(com.chart.all.anychart.graphics.vector.image.Align align) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image attr(String key, String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image clip(com.chart.all.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.chart.all.anychart.graphics.vector.Image clip(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image cursor(com.chart.all.anychart.graphics.vector.Cursor value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image desc(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.chart.all.anychart.graphics.vector.Image disableStrokeScaling(Boolean value) {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.chart.all.anychart.graphics.vector.Image drag(com.chart.all.anychart.graphics.math.Rect value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image fittingMode(com.chart.all.anychart.graphics.vector.image.Fitting mode) {
     ...
     * Setter for the fitting mode.
     */
    public com.chart.all.anychart.graphics.vector.Image fittingMode(String mode) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image height(Number height) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image id(String id) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image parent(com.chart.all.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.chart.all.anychart.graphics.vector.Image parent(com.chart.all.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image remove() {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image rotateByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Image rotateByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image scaleByAnchor(Number sx, Number sy, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.chart.all.anychart.graphics.vector.Image scaleByAnchor(Number sx, Number sy, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image setPosition(Number x, Number y) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Image setRotationByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Image setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
...
Set null value for non-display image.
     */
    public com.chart.all.anychart.graphics.vector.Image src(String url) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image title(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image translate(Number tx, Number ty) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image visible(Boolean isVisible) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image width(Number width) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image x(Number xCoord) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image y(Number yCoord) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Image zIndex(Number value) {
