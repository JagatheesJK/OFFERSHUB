...
Passed value is rounded and defaults to 1 in case of incorrect settings.
     */
    public com.chart.all.anychart.scales.OrdinalTicks interval(Number interval) {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalTicks maxCount(Number count) {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalTicks names(String[] names) {
     ...
     */
    public com.chart.all.anychart.scales.OrdinalTicks set(String[] ticks) {
