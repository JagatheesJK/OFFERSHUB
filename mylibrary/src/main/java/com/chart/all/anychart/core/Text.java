...
public class Text extends VisualBase {
     ...
     */
    public com.chart.all.anychart.core.Text disablePointerEvents(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.Text enabled(Boolean enabled) {
...
{@link https://www.w3schools.com/html/html_colors.asp}
     */
    public com.chart.all.anychart.core.Text fontColor(String color) {
     ...
     */
    public com.chart.all.anychart.core.Text fontDecoration(com.chart.all.anychart.graphics.vector.text.Decoration value) {
     ...
     * Setter for the text font decoration.
     */
    public com.chart.all.anychart.core.Text fontDecoration(String value) {
     ...
     */
    public com.chart.all.anychart.core.Text fontFamily(String family) {
     ...
     */
    public com.chart.all.anychart.core.Text fontOpacity(Number opacity) {
     ...
     */
    public com.chart.all.anychart.core.Text fontSize(String size) {
     ...
     * Setter for the text font size.
     */
    public com.chart.all.anychart.core.Text fontSize(Number size) {
     ...
     */
    public com.chart.all.anychart.core.Text fontStyle(com.chart.all.anychart.graphics.vector.text.FontStyle style) {
     ...
     * Setter for the text font style.
     */
    public com.chart.all.anychart.core.Text fontStyle(String style) {
     ...
     */
    public com.chart.all.anychart.core.Text fontVariant(com.chart.all.anychart.graphics.vector.text.FontVariant value) {
     ...
     * Setter for the text font variant.
     */
    public com.chart.all.anychart.core.Text fontVariant(String value) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.core.Text fontWeight(String weight) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.core.Text fontWeight(Number weight) {
     ...
     */
    public com.chart.all.anychart.core.Text hAlign(com.chart.all.anychart.graphics.vector.text.HAlign align) {
     ...
     * Setter for the text horizontal align.
     */
    public com.chart.all.anychart.core.Text hAlign(String align) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.core.Text letterSpacing(String spacing) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.core.Text letterSpacing(Number spacing) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.core.Text lineHeight(String height) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.core.Text lineHeight(Number height) {
     ...
     */
    public com.chart.all.anychart.core.Text selectable(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.Text textDirection(com.chart.all.anychart.graphics.vector.text.Direction direction) {
     ...
     * Setter for the text direction.
     */
    public com.chart.all.anychart.core.Text textDirection(String direction) {
     ...
     */
    public com.chart.all.anychart.core.Text textIndent(Number indent) {
     ...
     */
    public com.chart.all.anychart.core.Text textOverflow(com.chart.all.anychart.graphics.vector.text.TextOverflow value) {
     ...
     * Setter for the text overflow settings.
     */
    public com.chart.all.anychart.core.Text textOverflow(String value) {
     ...
     */
    public com.chart.all.anychart.core.Text textSettings(String name, String settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.core.Text textSettings(String name, Number settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.core.Text textSettings(String name, Boolean settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".textSettings(%s, %s);", wrapQuotes(name), settings));
     ...
     */
    public com.chart.all.anychart.core.Text useHtml(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.Text vAlign(com.chart.all.anychart.graphics.vector.text.VAlign align) {
     ...
     * Setter for the text vertical align.
     */
    public com.chart.all.anychart.core.Text vAlign(String align) {
     ...
     */
    public com.chart.all.anychart.core.Text wordBreak(com.chart.all.anychart.enums.WordBreak mode) {
     ...
     * Setter for the word-break mode.
     */
    public com.chart.all.anychart.core.Text wordBreak(String mode) {
     ...
     */
    public com.chart.all.anychart.core.Text wordWrap(com.chart.all.anychart.enums.WordWrap mode) {
     ...
     * Setter for the word-wrap mode.
     */
    public com.chart.all.anychart.core.Text wordWrap(String mode) {
     ...
     */
    public com.chart.all.anychart.core.Text zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.Text container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.Text container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.Text container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.Text parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.Text parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.Text parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.Text parentBounds(Number left, Number top, Number width, Number height) {
