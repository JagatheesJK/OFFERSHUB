...
public class Overlay extends Base {
     ...
     */
    public com.chart.all.anychart.core.gantt.Overlay className(String name) {
     ...
     */
    public com.chart.all.anychart.core.gantt.Overlay enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.gantt.Overlay id(String id) {
