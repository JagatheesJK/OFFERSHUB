...
public class Set extends Base {
     ...
     */
    public com.chart.all.anychart.data.Set append(String var_args) {
     ...
     */
    public com.chart.all.anychart.data.Set insert(String row, Number index) {
     ...
     * 
     */
    public com.chart.all.anychart.data.Mapping mapAs(String mapping) {
        return new com.chart.all.anychart.data.Mapping(String.format(Locale.US, jsBase + ".mapAs(%s)", wrapQuotes(mapping)));
    }
    /**
     * Removes the row by index.
     */
    public com.chart.all.anychart.data.Set remove(Number index) {
     ...
     * 
     */
    public com.chart.all.anychart.data.Set data(com.chart.all.anychart.data.View data) {
     ...
     * 
     */
    public com.chart.all.anychart.data.Set data(List<DataEntry> data, com.chart.all.anychart.enums.TreeFillingMethod fillMethod) {
     ...
     * 
     */
    public com.chart.all.anychart.data.Set data(List<DataEntry> data, String fillMethod) {
