...
public class Calendar extends Base {
     ...
     */
    public com.chart.all.anychart.scales.Calendar availabilities(com.chart.all.anychart.scales.calendar.Availability[] availabilities) {
     ...
     */
    public void getWorkingSchedule(Number startDate, Number endDate, com.chart.all.anychart.enums.Interval unit, Number count) {
     ...
     */
    public com.chart.all.anychart.scales.Calendar timezoneOffset(Number var_offset) {
     ...
     */
    public com.chart.all.anychart.scales.Calendar weekendRange(Number[] var_range) {
