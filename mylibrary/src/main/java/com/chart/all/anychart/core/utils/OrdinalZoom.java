...
public class OrdinalZoom extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.utils.OrdinalZoom continuous(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.utils.OrdinalZoom setTo(Number startRatio, Number endRatio) {
     ...
     */
    public com.chart.all.anychart.core.utils.OrdinalZoom setToPointsCount(Number pointsCount, Boolean fromEnd, com.chart.all.anychart.scales.Base scale) {
     ...
     * Setups zoom by passed values.
     */
    public com.chart.all.anychart.core.utils.OrdinalZoom setToValues(String startValue, String endValue, com.chart.all.anychart.scales.Base scale) {
