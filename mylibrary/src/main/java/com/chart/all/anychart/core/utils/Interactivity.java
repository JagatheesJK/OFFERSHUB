...
public class Interactivity extends Base {
     ...
     * 
     */
    public com.chart.all.anychart.core.utils.Interactivity allowMultiSeriesSelection(Boolean value) {
     ...
     */
    public com.chart.all.anychart.core.utils.Interactivity hoverMode(com.chart.all.anychart.enums.HoverMode mode) {
     ...
     * Setter for the hover mode.
     */
    public com.chart.all.anychart.core.utils.Interactivity hoverMode(String mode) {
     ...
     */
    public com.chart.all.anychart.core.utils.Interactivity multiSelectOnClick(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.utils.Interactivity selectionMode(com.chart.all.anychart.enums.SelectionMode mode) {
     ...
     * Setter for the selection mode.
     */
    public com.chart.all.anychart.core.utils.Interactivity selectionMode(String mode) {
...
<b>Note:</b> Works only with "by-spot" value in the {@link anychart.core.utils.Interactivity#hoverMode} method.
     */
    public com.chart.all.anychart.core.utils.Interactivity spotRadius(Number radius) {
...
If the value is <b>true<b/>, disables select all points when clicking outside the chart point.
     */
    public com.chart.all.anychart.core.utils.Interactivity unselectOnClickOutOfPoint(Boolean enabled) {
