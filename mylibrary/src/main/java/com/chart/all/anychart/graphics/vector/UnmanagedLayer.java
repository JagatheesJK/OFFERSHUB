...
public class UnmanagedLayer extends Element {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer attr(String key, String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer clip(com.chart.all.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer clip(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer content(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer cursor(com.chart.all.anychart.graphics.vector.Cursor value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer desc(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer disableStrokeScaling(Boolean value) {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer drag(com.chart.all.anychart.graphics.math.Rect value) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer id(String id) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer parent(com.chart.all.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer parent(com.chart.all.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer remove() {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer rotateByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer rotateByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer scaleByAnchor(Number sx, Number sy, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer scaleByAnchor(Number sx, Number sy, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer setPosition(Number x, Number y) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer setRotationByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer title(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer translate(Number tx, Number ty) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer visible(Boolean isVisible) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.UnmanagedLayer zIndex(Number value) {
