...
public class KDJ extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ dMAType(com.chart.all.anychart.enums.MovingAverageType type) {
     ...
     * Setter for the %D smoothing type.
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ dMAType(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ dMultiplier(Number multiplier) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ dPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ dSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator %D Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ dSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.series.Base jSeries() {
        return new com.chart.all.anychart.core.stock.series.Base(jsBase + ".jSeries()");
    }
    /**
     * Setter for the indicator %J Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ jSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator %J Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ jSeries(String type) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ kMAPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ kMAType(com.chart.all.anychart.enums.MovingAverageType period) {
     ...
     * Setter for the %K smoothing type.
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ kMAType(String period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ kMultiplier(Number multiplier) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ kPeriod(Number period) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ kSeries(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator %K Series type.
     */
    public com.chart.all.anychart.core.stock.indicators.KDJ kSeries(String type) {
