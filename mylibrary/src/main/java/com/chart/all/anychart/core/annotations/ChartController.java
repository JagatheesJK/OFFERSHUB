...
public class ChartController extends Base {
     ...
     */
    public com.chart.all.anychart.core.annotations.ChartController removeAllAnnotations() {
     ...
     */
    public com.chart.all.anychart.core.annotations.ChartController removeAnnotation(com.chart.all.anychart.core.annotations.Base annotation) {
     ...
     * Selects annotation.
     */
    public com.chart.all.anychart.core.annotations.ChartController select(com.chart.all.anychart.core.annotations.Base annotation) {
...
<b>Note:</b> Works only after {@link anychart.charts.Stock#draw} is called.
     ...
     */
    public com.chart.all.anychart.core.annotations.ChartController unselect() {
