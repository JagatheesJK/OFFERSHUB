...
public class GanttDateTime extends Base {
     ...
     */
    public com.chart.all.anychart.scales.GanttDateTime maximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.GanttDateTime maximumGap(Number gap) {
     ...
     */
    public com.chart.all.anychart.scales.GanttDateTime minimum(Number minimum) {
     ...
     */
    public com.chart.all.anychart.scales.GanttDateTime minimumGap(Number gap) {
     ...
     */
    public com.chart.all.anychart.scales.GanttDateTime softMaximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.GanttDateTime softMinimum(Number minimum) {
