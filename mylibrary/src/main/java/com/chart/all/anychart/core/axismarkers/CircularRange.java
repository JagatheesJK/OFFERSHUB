...
public class CircularRange extends VisualBase {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange axisIndex(Number index) {
...
Round off the ends of circular ranges to the specified radius.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange cornersRounding(Number value) {
...
Round off the ends of circular ranges to the specified radius.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange cornersRounding(String value) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange endSize(Number value) {
     ...
     * Setter for the range end size.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange endSize(String value) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange fill(com.chart.all.anychart.graphics.vector.Fill color) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange fill(com.chart.all.anychart.graphics.vector.GradientKey color) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".fill(%s);", (color != null) ? color.getJsBase() : null));
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange fill(String[] color) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange from(Number fromValue) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange position(com.chart.all.anychart.enums.GaugeSidePosition positionType) {
     ...
     * Setter for the range position.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange position(String positionType) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange radius(Number value) {
     ...
     * Setter for the range radius.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange radius(String value) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange startSize(Number value) {
     ...
     * Setter for the range start size.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange startSize(String value) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange to(Number toValue) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange parentBounds(Number left, Number top, Number width, Number height) {
     ...
     * 
     */
    public com.chart.all.anychart.core.axismarkers.CircularRange fill(String value) {
