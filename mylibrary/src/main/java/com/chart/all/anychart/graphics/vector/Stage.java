...
Similar to {@link anychart.graphics.vector.Layer#addChild}
     */
    public com.chart.all.anychart.graphics.vector.Stage addChild(com.chart.all.anychart.graphics.vector.Element element) {
...
Similar to {@link anychart.graphics.vector.Layer#addChildAt}
     */
    public com.chart.all.anychart.graphics.vector.Stage addChildAt(com.chart.all.anychart.graphics.vector.Element element, Number index) {
...
Read more at: {@link anychart.graphics.vector.Element#appendTransformationMatrix}.
     */
    public com.chart.all.anychart.graphics.vector.Stage appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage asyncMode(Boolean async) {
...
Read more at: {@link anychart.graphics.vector.Circle}
     */
    public com.chart.all.anychart.graphics.vector.Circle circle(Number cx, Number cy, Number radius) {
        return new com.chart.all.anychart.graphics.vector.Circle(String.format(Locale.US, jsBase + ".circle(%s, %s, %s)", cx, cy, radius));
    }
    /**
     * Gets clip bounds.<br/>
...
Read more at: {@link anychart.graphics.vector.Element#clip}.
     */
    public com.chart.all.anychart.graphics.vector.Stage clip(com.chart.all.anychart.graphics.math.Rect rect) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Clip createClip(Number[] rect) {
        return new com.chart.all.anychart.graphics.vector.Clip(String.format(Locale.US, jsBase + ".createClip(%s)", Arrays.toString(rect)));
    }
    /**
     * Creates a clip element using single value.
     */
    public com.chart.all.anychart.graphics.vector.Clip createClip(com.chart.all.anychart.graphics.math.Rect rect) {
        return new com.chart.all.anychart.graphics.vector.Clip(String.format(Locale.US, jsBase + ".createClip(%s)", (rect != null) ? rect.getJsBase() : null));
    }
    /**
     * Creates a clip element using single value.
     */
    public com.chart.all.anychart.graphics.vector.Clip createClip(String rect) {
        return new com.chart.all.anychart.graphics.vector.Clip(String.format(Locale.US, jsBase + ".createClip(%s)", wrapQuotes(rect)));
    }
    /**
     * Creates a clip element using several value.
     */
    public com.chart.all.anychart.graphics.vector.Clip createClip(Number left, Number top, Number width, Number height) {
        return new com.chart.all.anychart.graphics.vector.Clip(String.format(Locale.US, jsBase + ".createClip(%s, %s, %s, %s)", left, top, width, height));
    }
    /**
     * Getter for stage credits.
     */
    public com.chart.all.anychart.core.ui.StageCredits credits() {
        return new com.chart.all.anychart.core.ui.StageCredits(jsBase + ".credits()");
    }
    /**
     * Setter for stage credits.
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public com.chart.all.anychart.graphics.vector.Stage credits(String settings) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     */
    public com.chart.all.anychart.graphics.vector.Stage credits(Boolean settings) {
...
Read more at {@link anychart.graphics.vector.primitives#cross}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage desc(String text) {
...
Read more at: {@link anychart.graphics.vector.Ellipse}
     */
    public com.chart.all.anychart.graphics.vector.Ellipse ellipse(Number cx, Number cy, Number rx, Number ry) {
        return new com.chart.all.anychart.graphics.vector.Ellipse(String.format(Locale.US, jsBase + ".ellipse(%s, %s, %s, %s)", cx, cy, rx, ry));
    }
    /**
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage fullScreen(Boolean enabled) {
...
Similar to {@link anychart.graphics.vector.Layer#getChildAt}
     */
    public com.chart.all.anychart.graphics.vector.Element getChildAt(Number index) {
        return new com.chart.all.anychart.graphics.vector.Element(String.format(Locale.US, jsBase + ".getChildAt(%s)", index));
    }
    /**
...
Similar to {@link anychart.graphics.vector.Layer#hasChild}
     */
    public void hasChild(com.chart.all.anychart.graphics.vector.Element element) {
...
Read more at: {@link anychart.graphics.vector.HatchFill}
     */
    public com.chart.all.anychart.graphics.vector.HatchFill hatchFill(com.chart.all.anychart.graphics.vector.hatchfill.HatchFillType type, String color, Number thickness, Number size) {
        return new com.chart.all.anychart.graphics.vector.HatchFill(String.format(Locale.US, jsBase + ".hatchFill(%s, %s, %s, %s)", (type != null) ? type.getJsBase() : null, wrapQuotes(color), thickness, size));
    }
    /**
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage height(String height) {
     ...
     * Setter for a stage height.
     */
    public com.chart.all.anychart.graphics.vector.Stage height(Number height) {
...
If it was not set, than it will be generated.
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage id(String id) {
...
You must delete them yourself after you finish using them.
     */
    public com.chart.all.anychart.graphics.vector.Image image(String src, Number x, Number y, Number width, Number height) {
        return new com.chart.all.anychart.graphics.vector.Image(String.format(Locale.US, jsBase + ".image(%s, %s, %s, %s, %s)", wrapQuotes(src), x, y, width, height));
    }
    /**
     * Returns index of a child.<br/>
Similar to {@link anychart.graphics.vector.Layer#indexOfChild}
     */
    public void indexOfChild(com.chart.all.anychart.graphics.vector.Element element) {
...
You must delete them yourself after you finish using them.
     */
    public com.chart.all.anychart.graphics.vector.Layer layer() {
        return new com.chart.all.anychart.graphics.vector.Layer(jsBase + ".layer()");
    }
    /**
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage maxResizeDelay(Number delay) {
...
Similar to {@link anychart.graphics.vector.Layer#numChildren}
     ...
     * Returns self.
     */
    public com.chart.all.anychart.graphics.vector.Stage parent() {
...
Read more at Path: {@link anychart.graphics.vector.Path}
     */
    public com.chart.all.anychart.graphics.vector.Path path() {
        return new com.chart.all.anychart.graphics.vector.Path(jsBase + ".path()");
    }
    /**
...
Read more at: {@link anychart.graphics.vector.PatternFill}
     */
    public com.chart.all.anychart.graphics.vector.PatternFill pattern(com.chart.all.anychart.graphics.math.Rect bounds) {
        return new com.chart.all.anychart.graphics.vector.PatternFill(String.format(Locale.US, jsBase + ".pattern(%s)", (bounds != null) ? bounds.getJsBase() : null));
    }
    /**
...
You must delete them yourself after you finish using them.
     */
    public com.chart.all.anychart.graphics.vector.Rect rect(Number x, Number y, Number width, Number height) {
        return new com.chart.all.anychart.graphics.vector.Rect(String.format(Locale.US, jsBase + ".rect(%s, %s, %s, %s)", x, y, width, height));
    }
    /**
     * Removes everything.
     */
    public com.chart.all.anychart.graphics.vector.Stage remove() {
...
Similar to {@link anychart.graphics.vector.Layer#removeChild}
     */
    public com.chart.all.anychart.graphics.vector.Element removeChild(com.chart.all.anychart.graphics.vector.Element element) {
        return new com.chart.all.anychart.graphics.vector.Element(String.format(Locale.US, jsBase + ".removeChild(%s)", (element != null) ? element.getJsBase() : null));
    }
    /**
     * Removes an element by index.<br/>
Similar to {@link anychart.graphics.vector.Layer#removeChildAt}
     */
    public com.chart.all.anychart.graphics.vector.Element removeChildAt(Number index) {
        return new com.chart.all.anychart.graphics.vector.Element(String.format(Locale.US, jsBase + ".removeChildAt(%s)", index));
    }
    /**
...
Read more at {@link anychart.graphics.vector.Stage#suspend}.
     */
    public com.chart.all.anychart.graphics.vector.Stage resume(Boolean force) {
...
Read more at: {@link anychart.graphics.vector.Element#rotate}.
     */
    public com.chart.all.anychart.graphics.vector.Stage rotate(Number degrees, Number cx, Number cy) {
...
Read more at: {@link anychart.graphics.vector.Element#rotateByAnchor}.
     */
    public com.chart.all.anychart.graphics.vector.Stage rotateByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
...
Read more at: {@link anychart.graphics.vector.Element#rotateByAnchor}.
     */
    public com.chart.all.anychart.graphics.vector.Stage rotateByAnchor(Number degrees, String anchor) {
...
Read more at: {@link anychart.graphics.vector.Element#scale}.
     */
    public com.chart.all.anychart.graphics.vector.Stage scale(Number sx, Number sy, Number cx, Number cy) {
...
Read more at: {@link anychart.graphics.vector.Element#scaleByAnchor}.
     */
    public com.chart.all.anychart.graphics.vector.Stage scaleByAnchor(Number sx, Number sy, com.chart.all.anychart.graphics.vector.Anchor anchor) {
...
Read more at: {@link anychart.graphics.vector.Element#scaleByAnchor}.
     */
    public com.chart.all.anychart.graphics.vector.Stage scaleByAnchor(Number sx, Number sy, String anchor) {
...
Read more at: {@link anychart.graphics.vector.Element#setPosition}.
     */
    public com.chart.all.anychart.graphics.vector.Stage setPosition(Number x, Number y) {
...
Read more at: {@link anychart.graphics.vector.Element#setRotation}.
     */
    public com.chart.all.anychart.graphics.vector.Stage setRotation(Number degrees, Number cx, Number cy) {
...
Read more at: {@link anychart.graphics.vector.Element#setRotationByAnchor}.
     */
    public com.chart.all.anychart.graphics.vector.Stage setRotationByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
...
Read more at: {@link anychart.graphics.vector.Element#setRotationByAnchor}.
     */
    public com.chart.all.anychart.graphics.vector.Stage setRotationByAnchor(Number degrees, String anchor) {
...
Read more at: {@link anychart.graphics.vector.Element#setTransformationMatrix}.
     */
    public com.chart.all.anychart.graphics.vector.Stage setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
...
Read more at {@link anychart.graphics.vector.primitives#star7}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage suspend() {
...
Similar to {@link anychart.graphics.vector.Layer#swapChildren}
     */
    public com.chart.all.anychart.graphics.vector.Stage swapChildren(com.chart.all.anychart.graphics.vector.Element element1, com.chart.all.anychart.graphics.vector.Element element2) {
...
Similar to {@link anychart.graphics.vector.Layer#swapChildrenAt}
     */
    public com.chart.all.anychart.graphics.vector.Stage swapChildrenAt(Number index1, Number index2) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage title(String text) {
...
Read more at: {@link anychart.graphics.vector.Element#translate}.
     */
    public com.chart.all.anychart.graphics.vector.Stage translate(Number tx, Number ty) {
...
Read more at {@link anychart.graphics.vector.primitives#vLine}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage visible(Boolean isVisible) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Stage width(String width) {
     ...
     * Setter for a stage width.
     */
    public com.chart.all.anychart.graphics.vector.Stage width(Number width) {
     ...
     * 
     */
    public com.chart.all.anychart.graphics.vector.Stage data(com.chart.all.anychart.data.View data) {
     ...
     * 
     */
    public com.chart.all.anychart.graphics.vector.Stage data(List<DataEntry> data, com.chart.all.anychart.enums.TreeFillingMethod fillMethod) {
     ...
     * 
     */
    public com.chart.all.anychart.graphics.vector.Stage data(List<DataEntry> data, String fillMethod) {
