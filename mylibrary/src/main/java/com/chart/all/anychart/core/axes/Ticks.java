...
public class Ticks extends VisualBase {
     ...
     */
    public com.chart.all.anychart.core.axes.Ticks enabled(Boolean enabled) {
...
<img src='/si/8.4.0/anychart.core.axes.Ticks.length.png' height='77' width='412'/>
     */
    public com.chart.all.anychart.core.axes.Ticks length(Number length) {
...
<img src='/si/8.4.0/anychart.core.axes.Ticks.position.png' height='152' width='401'/>
     */
    public com.chart.all.anychart.core.axes.Ticks position(com.chart.all.anychart.enums.SidePosition position) {
...
<img src='/si/8.4.0/anychart.core.axes.Ticks.position.png' height='152' width='401'/>
     */
    public com.chart.all.anychart.core.axes.Ticks position(String position) {
...
<img src='/si/8.4.0/anychart.core.axes.Ticks.stroke.png' height='66' width='413'/>
     */
    public com.chart.all.anychart.core.axes.Ticks stroke(com.chart.all.anychart.graphics.vector.Stroke color) {
...
<b>Note:</b> String parts order is significant and '3px red' is not the same as 'red 3px'.
     */
    public com.chart.all.anychart.core.axes.Ticks stroke(String color, Number thickness, String dashpattern, String lineJoin, String lineCap) {
...
<b>Note:</b> String parts order is significant and '3px red' is not the same as 'red 3px'.
     */
    public com.chart.all.anychart.core.axes.Ticks stroke(String color, Number thickness, String dashpattern, String lineJoin, com.chart.all.anychart.graphics.vector.StrokeLineCap lineCap) {
...
<b>Note:</b> String parts order is significant and '3px red' is not the same as 'red 3px'.
     */
    public com.chart.all.anychart.core.axes.Ticks stroke(String color, Number thickness, String dashpattern, com.chart.all.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
...
<b>Note:</b> String parts order is significant and '3px red' is not the same as 'red 3px'.
     */
    public com.chart.all.anychart.core.axes.Ticks stroke(String color, Number thickness, String dashpattern, com.chart.all.anychart.graphics.vector.StrokeLineJoin lineJoin, com.chart.all.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     */
    public com.chart.all.anychart.core.axes.Ticks stroke(String settings) {
     ...
     */
    public com.chart.all.anychart.core.axes.Ticks zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.axes.Ticks container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.axes.Ticks container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.axes.Ticks container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axes.Ticks parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axes.Ticks parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axes.Ticks parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axes.Ticks parentBounds(Number left, Number top, Number width, Number height) {
