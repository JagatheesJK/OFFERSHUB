...
public class StageCredits extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.ui.StageCredits alt(String text) {
     ...
     */
    public com.chart.all.anychart.core.ui.StageCredits enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.ui.StageCredits imgAlt(String alt) {
...
<b>Note:</b> <b>Note:</b> You can't customize credits without <u>a license key</u>. See <a href="https://www.anychart.com/buy/">AnyChart Licensing</a> to learn more.
     */
    public com.chart.all.anychart.core.ui.StageCredits logoSrc(String logoSrc) {
     ...
     */
    public com.chart.all.anychart.core.ui.StageCredits text(String text) {
     ...
     */
    public com.chart.all.anychart.core.ui.StageCredits url(String url) {
