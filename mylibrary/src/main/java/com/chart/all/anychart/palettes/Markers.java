...
public class Markers extends Base {
     ...
     */
    public com.chart.all.anychart.palettes.Markers itemAt(Number index, com.chart.all.anychart.enums.MarkerType type) {
     ...
     * Setter for type palette markers from list by index.
     */
    public com.chart.all.anychart.palettes.Markers itemAt(Number index, com.chart.all.anychart.enums.BulletMarkerType type) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".itemAt(%s, %s);", index, (type != null) ? type.getJsBase() : null));
     ...
     * Setter for type palette markers from list by index.
     */
    public com.chart.all.anychart.palettes.Markers itemAt(Number index, String type) {
     ...
     */
    public com.chart.all.anychart.palettes.Markers items(String[] type, String var_args) {
     ...
     * Setter for markers list of palette.
     */
    public com.chart.all.anychart.palettes.Markers items(com.chart.all.anychart.enums.MarkerType type, String var_args) {
     ...
     * Setter for markers list of palette.
     */
    public com.chart.all.anychart.palettes.Markers items(com.chart.all.anychart.enums.BulletMarkerType type, String var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (type != null) ? type.getJsBase() : null, wrapQuotes(var_args)));
