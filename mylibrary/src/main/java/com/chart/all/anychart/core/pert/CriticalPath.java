...
public class CriticalPath extends Base {
     ...
     */
    public com.chart.all.anychart.core.pert.CriticalPath milestones(String settings) {
     ...
     */
    public com.chart.all.anychart.core.pert.CriticalPath tasks(String settings) {
