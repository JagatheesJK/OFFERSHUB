...
import com.chart.all.anychart.scales.Base;
...
public class ScatterBase extends Base {
     ...
     */
    public com.chart.all.anychart.scales.ScatterBase alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public com.chart.all.anychart.scales.ScatterBase alignMinimum(Boolean enabled) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public com.chart.all.anychart.scales.ScatterBase extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public com.chart.all.anychart.scales.ScatterBase inverted(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.scales.ScatterBase maxTicksCount(Number count) {
     ...
     */
    public com.chart.all.anychart.scales.ScatterBase maximum(Number maximum) {
     ...
     */
    public com.chart.all.anychart.scales.ScatterBase minimum(Number minimum) {
...
call of this method if needed.
     */
    public com.chart.all.anychart.scales.ScatterBase startAutoCalc() {
