...
public class Point extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.Point hovered(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.Point selected(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.Point set(String field, String value) {
