...
public class Node extends Base {
     ...
     */
    public com.chart.all.anychart.core.sankey.elements.Node hovered(String value) {
     ...
     */
    public com.chart.all.anychart.core.sankey.elements.Node normal(String settings) {
     ...
     */
    public com.chart.all.anychart.core.sankey.elements.Node tooltip(String settings) {
     ...
     * Setter for the tooltip.
     */
    public com.chart.all.anychart.core.sankey.elements.Node tooltip(Boolean settings) {
