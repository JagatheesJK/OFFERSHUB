...
import com.chart.all.anychart.core.utils.Interactivity;
...
public class MapInteractivity extends Interactivity {
     ...
     * 
     */
    public com.chart.all.anychart.core.utils.MapInteractivity allowMultiSeriesSelection(Boolean value) {
...
{docs:Common_Settings/Text_Formatters}Learn more about using copyFormat() method.{docs}
     */
    public com.chart.all.anychart.core.utils.MapInteractivity copyFormat(String formatFunction) {
...
<b>Note:</b> Works only with {@link anychart.charts.Map#zoom}
     */
    public com.chart.all.anychart.core.utils.MapInteractivity drag(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.utils.MapInteractivity hoverMode(com.chart.all.anychart.enums.HoverMode mode) {
     ...
     * Setter for the hover mode.
     */
    public com.chart.all.anychart.core.utils.MapInteractivity hoverMode(String mode) {
     ...
     */
    public com.chart.all.anychart.core.utils.MapInteractivity keyboardZoomAndMove(Boolean enabled) {
     ...
     * 
     */
    public com.chart.all.anychart.core.utils.MapInteractivity mouseWheel(Boolean value) {
     ...
     */
    public com.chart.all.anychart.core.utils.MapInteractivity multiSelectOnClick(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.utils.MapInteractivity selectionMode(com.chart.all.anychart.enums.SelectionMode mode) {
     ...
     * Setter for the selection mode.
     */
    public com.chart.all.anychart.core.utils.MapInteractivity selectionMode(String mode) {
...
<b>Note:</b> Works only with "by-spot" value in the {@link anychart.core.utils.Interactivity#hoverMode} method.
     */
    public com.chart.all.anychart.core.utils.MapInteractivity spotRadius(Number radius) {
...
If the value is <b>true<b/>, disables select all points when clicking outside the chart point.
     */
    public com.chart.all.anychart.core.utils.MapInteractivity unselectOnClickOutOfPoint(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.utils.MapInteractivity zoomOnDoubleClick(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.utils.MapInteractivity zoomOnMouseWheel(Boolean enabled) {
