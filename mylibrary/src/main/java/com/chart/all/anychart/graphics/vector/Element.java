...
public class Element extends JsObject {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element attr(String key, String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element clip(com.chart.all.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.chart.all.anychart.graphics.vector.Element clip(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element cursor(com.chart.all.anychart.graphics.vector.Cursor value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element desc(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.chart.all.anychart.graphics.vector.Element disableStrokeScaling(Boolean value) {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.chart.all.anychart.graphics.vector.Element drag(com.chart.all.anychart.graphics.math.Rect value) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element id(String id) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element parent(com.chart.all.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.chart.all.anychart.graphics.vector.Element parent(com.chart.all.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element remove() {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element rotateByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Element rotateByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element scaleByAnchor(Number sx, Number sy, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.chart.all.anychart.graphics.vector.Element scaleByAnchor(Number sx, Number sy, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element setPosition(Number x, Number y) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Element setRotationByAnchor(Number degrees, com.chart.all.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.chart.all.anychart.graphics.vector.Element setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element title(String value) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element translate(Number tx, Number ty) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element visible(Boolean isVisible) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Element zIndex(Number value) {
