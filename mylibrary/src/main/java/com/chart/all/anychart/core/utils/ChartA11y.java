...
import com.chart.all.anychart.core.utils.A11y;
...
public class ChartA11y extends A11y {
     ...
     */
    public com.chart.all.anychart.core.utils.ChartA11y enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.utils.ChartA11y mode(com.chart.all.anychart.enums.A11yMode mode) {
     ...
     * Setter for the accessibility mode.
     */
    public com.chart.all.anychart.core.utils.ChartA11y mode(String mode) {
...
{docs:Common_Settings/Text_Formatters}Learn more about using titleFormat() method.{docs}
     */
    public com.chart.all.anychart.core.utils.ChartA11y titleFormat(String formatSettings) {
