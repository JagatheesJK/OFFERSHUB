package com.chart.all.anychart.standalones.axismarkers;
...
public class Text extends JsObject {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text align(com.chart.all.anychart.enums.Align align) {
     ...
     * Setter for the text marker align.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text align(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text anchor(com.chart.all.anychart.enums.Anchor anchor) {
     ...
     * Setter for the text marker anchor settings.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text anchor(String anchor) {
     ...
     */
    public com.chart.all.anychart.core.axismarkers.Line axis(com.chart.all.anychart.core.axes.Linear axis) {
        return new com.chart.all.anychart.core.axismarkers.Line(String.format(Locale.US, jsBase + ".axis(%s)", (axis != null) ? axis.getJsBase() : null));
    }
    /**
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text background(String settings) {
     ...
     * Setter for the background.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text background(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the text marker container.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the text marker container.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text container(String element) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text disablePointerEvents(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text draw() {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text enabled(Boolean enabled) {
...
{@link https://www.w3schools.com/html/html_colors.asp}
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontColor(String color) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontDecoration(com.chart.all.anychart.graphics.vector.text.Decoration value) {
     ...
     * Setter for the text font decoration.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontDecoration(String value) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontFamily(String family) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontOpacity(Number opacity) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontSize(String size) {
     ...
     * Setter for the text font size.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontSize(Number size) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontStyle(com.chart.all.anychart.graphics.vector.text.FontStyle style) {
     ...
     * Setter for the text font style.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontStyle(String style) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontVariant(com.chart.all.anychart.graphics.vector.text.FontVariant value) {
     ...
     * Setter for the text font variant.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontVariant(String value) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontWeight(String weight) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.chart.all.anychart.standalones.axismarkers.Text fontWeight(Number weight) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text hAlign(com.chart.all.anychart.graphics.vector.text.HAlign align) {
     ...
     * Setter for the text horizontal align.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text hAlign(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text height(Number height) {
     ...
     * Setter for the text marker height.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text height(String height) {
...
Layout is define by {@link anychart.core.axisMarkers.Text#layout} method.
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text layout(com.chart.all.anychart.enums.Layout layout) {
     ...
     * Setter for text marker layout.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text layout(String layout) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.standalones.axismarkers.Text letterSpacing(String spacing) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.chart.all.anychart.standalones.axismarkers.Text letterSpacing(Number spacing) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.standalones.axismarkers.Text lineHeight(String height) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.chart.all.anychart.standalones.axismarkers.Text lineHeight(Number height) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text offsetX(Number offset) {
     ...
     * Setter for the text marker offset by x.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text offsetX(String offset) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text offsetY(Number offset) {
     ...
     * Setter for the text marker offset by y.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text offsetY(String offset) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number[] padding) {
     ...
     * Setter for the text marker padding in pixels by one value.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String[] padding) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String value1, String value2, String value3, String value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String value1, String value2, String value3, Number value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String value1, String value2, Number value3, String value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String value1, Number value2, String value3, String value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(String value1, Number value2, Number value3, Number value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number value1, String value2, String value3, String value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number value1, String value2, String value3, Number value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number value1, String value2, Number value3, String value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number value1, String value2, Number value3, Number value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number value1, Number value2, String value3, String value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number value1, Number value2, String value3, Number value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number value1, Number value2, Number value3, String value4) {
     ...
     * Setter for the text marker padding in pixels using several numbers.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text padding(Number value1, Number value2, Number value3, Number value4) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text parentBounds(com.chart.all.anychart.math.Rect bounds) {
     ...
     * Setter for bounds using single value.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text parentBounds(String bounds) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text parentBounds(Number left, Number top, Number width, Number height) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text rotation(Number rotation) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text scale(com.chart.all.anychart.scales.Base settings) {
     ...
     * Setter for the text marker scale.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text scale(String settings) {
     ...
     * Setter for the text marker scale.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text scale(com.chart.all.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".scale(%s);", (settings != null) ? settings.getJsBase() : null));
...
The 'consider' mode consideres the marker value in the scale.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text scaleRangeMode(String mode) {
...
The 'consider' mode consideres the marker value in the scale.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text scaleRangeMode(com.chart.all.anychart.enums.ScaleRangeMode mode) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text selectable(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text text(String text) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text textDirection(com.chart.all.anychart.graphics.vector.text.Direction direction) {
     ...
     * Setter for the text direction.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text textDirection(String direction) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text textIndent(Number indent) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text textOverflow(com.chart.all.anychart.graphics.vector.text.TextOverflow value) {
     ...
     * Setter for the text overflow settings.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text textOverflow(String value) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text textSettings(String name, String settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text textSettings(String name, Number settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text textSettings(String name, Boolean settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".textSettings(%s, %s);", wrapQuotes(name), settings));
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text useHtml(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text vAlign(com.chart.all.anychart.graphics.vector.text.VAlign align) {
     ...
     * Setter for the text vertical align.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text vAlign(String align) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text value(Number value) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text width(Number width) {
     ...
     * Setter for the text marker width.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text width(String width) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text wordBreak(com.chart.all.anychart.enums.WordBreak mode) {
     ...
     * Setter for the word-break mode.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text wordBreak(String mode) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text wordWrap(com.chart.all.anychart.enums.WordWrap mode) {
     ...
     * Setter for the word-wrap mode.
     */
    public com.chart.all.anychart.standalones.axismarkers.Text wordWrap(String mode) {
     ...
     */
    public com.chart.all.anychart.standalones.axismarkers.Text zIndex(Number zIndex) {
