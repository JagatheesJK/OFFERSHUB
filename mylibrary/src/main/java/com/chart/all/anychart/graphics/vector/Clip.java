...
public class Clip extends JsObject {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Shape shape() {
        return new com.chart.all.anychart.graphics.vector.Shape(jsBase + ".shape()");
    }
    /**
     * Setter for the shape of the clip.
     */
    public com.chart.all.anychart.graphics.vector.Clip shape(Number[] shape) {
     ...
     * Setter for the shape of the clip.
     */
    public com.chart.all.anychart.graphics.vector.Clip shape(com.chart.all.anychart.graphics.vector.Shape shape) {
     ...
     * Setter for the shape of the clip.
     */
    public com.chart.all.anychart.graphics.vector.Clip shape(com.chart.all.anychart.graphics.math.Rect shape) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".shape(%s);", (shape != null) ? shape.getJsBase() : null));
     ...
     * Setter for the shape of the clip.
     */
    public com.chart.all.anychart.graphics.vector.Clip shape(String shape) {
     ...
     */
    public com.chart.all.anychart.graphics.vector.Clip shape(Number left, Number top, Number width, Number height) {
