...
<b>Note:</b> Defines how many steps we need in gradient.
     */
    public com.chart.all.anychart.palettes.RangeColors count(Number count) {
     ...
     */
    public com.chart.all.anychart.palettes.RangeColors itemAt(Number index, com.chart.all.anychart.graphics.vector.SolidFill color) {
     ...
     */
    public com.chart.all.anychart.palettes.RangeColors items(String[] color, com.chart.all.anychart.graphics.vector.SolidFill var_args) {
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(String[] color, String var_args) {
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(com.chart.all.anychart.graphics.vector.LinearGradientFill color, com.chart.all.anychart.graphics.vector.SolidFill var_args) {
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(com.chart.all.anychart.graphics.vector.LinearGradientFill color, String var_args) {
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(com.chart.all.anychart.graphics.vector.RadialGradientFill color, com.chart.all.anychart.graphics.vector.SolidFill var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (color != null) ? color.getJsBase() : null, (var_args != null) ? var_args.getJsBase() : null));
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(com.chart.all.anychart.graphics.vector.RadialGradientFill color, String var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (color != null) ? color.getJsBase() : null, wrapQuotes(var_args)));
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(com.chart.all.anychart.graphics.vector.GradientKey[] color, com.chart.all.anychart.graphics.vector.SolidFill var_args) {
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(com.chart.all.anychart.graphics.vector.GradientKey[] color, String var_args) {
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(com.chart.all.anychart.graphics.vector.SolidFill color, com.chart.all.anychart.graphics.vector.SolidFill var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (color != null) ? color.getJsBase() : null, (var_args != null) ? var_args.getJsBase() : null));
     ...
     * Setter for color palette colors list.
     */
    public com.chart.all.anychart.palettes.RangeColors items(com.chart.all.anychart.graphics.vector.SolidFill color, String var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (color != null) ? color.getJsBase() : null, wrapQuotes(var_args)));
