...
public class PSAR extends JsObject {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.PSAR accelerationFactorIncrement(Number factor) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.PSAR accelerationFactorMaximum(Number factor) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.PSAR accelerationFactorStart(Number factor) {
     ...
     */
    public com.chart.all.anychart.core.stock.indicators.PSAR series(com.chart.all.anychart.enums.StockSeriesType type) {
     ...
     * Setter for the indicator series type.
     */
    public com.chart.all.anychart.core.stock.indicators.PSAR series(String type) {
