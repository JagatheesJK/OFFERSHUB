...
public class SeriesBase extends VisualBaseWithBounds {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase a11y(Boolean value) {
     ...
     * Setter for the accessibility setting.
     */
    public com.chart.all.anychart.core.SeriesBase a11y(String value) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.chart.all.anychart.core.SeriesBase bottom(String bottom) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase bounds(com.chart.all.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(com.chart.all.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(com.chart.all.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.core.SeriesBase bounds(Number x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(Number x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(Number x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(Number x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(Number x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(Number x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(Number x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(Number x, String y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(String x, Number y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(String x, Number y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(String x, Number y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(String x, Number y, String width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(String x, String y, Number width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(String x, String y, Number width, String height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(String x, String y, String width, Number height) {
     ...
     * Setter for element bounds settings.
     */
    public com.chart.all.anychart.core.SeriesBase bounds(String x, String y, String width, String height) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase colorScale(com.chart.all.anychart.scales.LinearColor settings) {
     ...
     * Setter for the color scale.
     */
    public com.chart.all.anychart.core.SeriesBase colorScale(com.chart.all.anychart.scales.OrdinalColor settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     * Setter for the color scale.
     */
    public com.chart.all.anychart.core.SeriesBase colorScale(String settings) {
     ...
     * Setter for the color scale.
     */
    public com.chart.all.anychart.core.SeriesBase colorScale(com.chart.all.anychart.enums.ScaleTypes settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colorScale(%s);", (settings != null) ? settings.getJsBase() : null));
     ...
     */
    public com.chart.all.anychart.core.SeriesBase enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.chart.all.anychart.core.SeriesBase height(String height) {
     ...
     * Hovers points.
     */
    public com.chart.all.anychart.core.SeriesBase hover() {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase hover(Number index) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase hover(Number[] indexes) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase hovered(String value) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase id(String id) {
     ...
     * Setter for the series id.
     */
    public com.chart.all.anychart.core.SeriesBase id(Number id) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase labels(String settings) {
     ...
     * Setter for the series data labels.
     */
    public com.chart.all.anychart.core.SeriesBase labels(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.chart.all.anychart.core.SeriesBase left(String left) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase legendItem(String settings) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase markers(String value) {
     ...
     * Setter for series data markers.
     */
    public com.chart.all.anychart.core.SeriesBase markers(Boolean value) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.chart.all.anychart.core.SeriesBase maxHeight(String height) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.chart.all.anychart.core.SeriesBase maxWidth(String width) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase meta(String object, String value) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.chart.all.anychart.core.SeriesBase minHeight(String height) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.chart.all.anychart.core.SeriesBase minWidth(String width) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase name(String name) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase normal(String value) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.chart.all.anychart.core.SeriesBase right(String right) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase select(Number index) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase select(Number[] indexes) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase selected(String value) {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public com.chart.all.anychart.core.SeriesBase selectionMode(com.chart.all.anychart.enums.SelectionMode value) {
...
To select multiple points, press 'ctrl' and click on them.
     */
    public com.chart.all.anychart.core.SeriesBase selectionMode(String value) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase tooltip(String settings) {
     ...
     * Setter for the series data tooltip.
     */
    public com.chart.all.anychart.core.SeriesBase tooltip(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.chart.all.anychart.core.SeriesBase top(String top) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase unhover(Number indexOrIndexes) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase unselect() {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase unselect(Number index) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase unselect(Number[] indexes) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.chart.all.anychart.core.SeriesBase width(String width) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.SeriesBase container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.SeriesBase container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.SeriesBase container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.SeriesBase parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.SeriesBase parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.SeriesBase parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.SeriesBase parentBounds(Number left, Number top, Number width, Number height) {
