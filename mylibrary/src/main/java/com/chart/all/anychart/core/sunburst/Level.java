package com.chart.all.anychart.core.sunburst;
...
public class Level extends Base {
     ...
     */
    public com.chart.all.anychart.core.sunburst.Level enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.sunburst.Level hovered(String settings) {
     ...
     */
    public com.chart.all.anychart.core.sunburst.Level labels(String settings) {
     ...
     * Setter for the labels settings.
     */
    public com.chart.all.anychart.core.sunburst.Level labels(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.sunburst.Level normal(String settings) {
     ...
     */
    public com.chart.all.anychart.core.sunburst.Level selected(String settings) {
     ...
     */
    public com.chart.all.anychart.core.sunburst.Level thickness(String thickness) {
     ...
     * Setter for the level thickness.
     */
    public com.chart.all.anychart.core.sunburst.Level thickness(Number thickness) {
