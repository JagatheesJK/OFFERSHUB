...
public class ContextMenu extends JsObject {
     ...
     */
    public com.chart.all.anychart.ui.ContextMenu attach(com.chart.all.anychart.core.Chart target, Boolean capture) {
     ...
     */
    public com.chart.all.anychart.ui.ContextMenu enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.ui.ContextMenu items(com.chart.all.anychart.ui.contextmenu.Item[] itemsList) {
...
<b>Note</b>: Items provider called before items formatter.
     ...
     */
    public com.chart.all.anychart.ui.ContextMenu setup(String var_args) {
     ...
     * Setups the element using passed configuration value.
     */
    public com.chart.all.anychart.ui.ContextMenu setup(Number var_args) {
     ...
     * Setups the element using passed configuration value.
     */
    public com.chart.all.anychart.ui.ContextMenu setup(Boolean var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".setup(%s);", var_args));
