...
public class StockDateTime extends VisualBase {
     ...
     */
    public com.chart.all.anychart.core.axes.StockDateTime background(String settings) {
     ...
     * Setter for axis background settings.
     */
    public com.chart.all.anychart.core.axes.StockDateTime background(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.axes.StockDateTime enabled(Boolean enabled) {
     ...
     */
    public com.chart.all.anychart.core.axes.StockDateTime height(Number height) {
     ...
     */
    public com.chart.all.anychart.core.axes.StockDateTime labels(String settings) {
     ...
     * Setter for axis labels settings.
     */
    public com.chart.all.anychart.core.axes.StockDateTime labels(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.axes.StockDateTime minorLabels(String settings) {
     ...
     * Setter for minor labels settings.
     */
    public com.chart.all.anychart.core.axes.StockDateTime minorLabels(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.axes.StockDateTime minorTicks(String settings) {
     ...
     * Setter for the minor ticks.
     */
    public com.chart.all.anychart.core.axes.StockDateTime minorTicks(Boolean settings) {
...
Whether to allow labels to overlap.
     */
    public com.chart.all.anychart.core.axes.StockDateTime overlapMode(com.chart.all.anychart.enums.StockLabelsOverlapMode mode) {
...
Whether to allow labels to overlap.
     */
    public com.chart.all.anychart.core.axes.StockDateTime overlapMode(String mode) {
...
Whether to draw helper label (leftmost hanging label).
     */
    public com.chart.all.anychart.core.axes.StockDateTime showHelperLabel(Boolean settings) {
     ...
     * Getter for axis ticks.
     */
    public com.chart.all.anychart.core.axes.StockDateTime ticks(String settings) {
     ...
     * Getter for axis ticks.
     */
    public com.chart.all.anychart.core.axes.StockDateTime ticks(Boolean settings) {
     ...
     */
    public com.chart.all.anychart.core.axes.StockDateTime zIndex(Number zIndex) {
     ...
     */
    public com.chart.all.anychart.core.axes.StockDateTime container(com.chart.all.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.axes.StockDateTime container(com.chart.all.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.chart.all.anychart.core.axes.StockDateTime container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axes.StockDateTime parentBounds(com.chart.all.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axes.StockDateTime parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axes.StockDateTime parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.chart.all.anychart.core.axes.StockDateTime parentBounds(Number left, Number top, Number width, Number height) {
